      ...
      <div className="results">
        <header>
          ...
          <div className="info container">
            <div className="boss">
              <a
                href={`https://classic.warcraftlogs.com/character/${this.props.region}/${this.state.realmSlug}/${this.props.name}`}
                target="_blank"
                rel="noopener noreferrer"
                className="btn"
                style={{ fontSize: 22 }}
              ...
              <br />
              <a
                href={`https://www.wipefest.net/character/${this.props.name}/${this.state.realmSlug}/${this.props.region}?gameVersion=warcraft-classic`}
                target="_blank"
                rel="noopener noreferrer"
                className="btn"
                style={{ fontSize: 22 }}
