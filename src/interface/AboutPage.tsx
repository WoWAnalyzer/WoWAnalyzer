  ...
  <>
    ...
    <Panel title={<Trans id="interface.aboutPage.title">About WoWAnalyzer</Trans>}>
      ...
      <Trans id="interface.aboutPage.about">
        ...
        you're a new player learning a spec for the first time or an experienced player looking for
        information to help you min-max, WoWAnalyzer is a great tool to have in your arsenal!
      </Trans>
      <br />
      <br />
