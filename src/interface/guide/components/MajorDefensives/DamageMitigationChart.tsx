...
import { GoodColor, useAnalyzers, useEvents, useInfo } from 'interface/guide';
...
import { isMajorDefensive } from 'interface/guide/components/MajorDefensives/core';
...
export const DamageMitigationChart = React.memo(
  <T extends typeof Analyzer>({
    ...
    const mitigationData = analyzers.flatMap((analyzer) => {
      if (!analyzer || !isMajorDefensive(analyzer)) {
        return [];
      }
