    ...
    <div className="container">
      <Warning style={{ marginBottom: 30 }}>
        ...
        <Trans id="interface.report.encountersNotFoundWarning.noEncountersFoundDetails">
          We were unable to find any encounters in this report. If Warcraft Logs shows a dungeon or boss encounter on this report, then try refreshing this page by pressing the refresh button in the top right of the page to re-pull the report from Warcraft Logs. Additionally, please note that due to the way combat logs work, we are unable to evaluate Target Dummy logs.
        </Trans>
      </Warning>
    </div>
  );
