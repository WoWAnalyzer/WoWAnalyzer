    ...
    return (
      <div className="panel">
        <div className="panel-heading">
          ...
          <small>Some of these suggestions may be nitpicky or fight dependent, but often it's still something you could look to improve. Try to focus on improving one thing at a time - don't try to improve everything at once.</small>
        </div>
