      ...
      <div>
        ...
        <div>
          ...
          <tbody>
              ...
              <tr><td>Soothing Mist</td><td>{overhealingSpell(SPELLS.SOOTHING_MIST.id)}</td><td>{(parser.getModule(SoothingMist).soomTicks / (parser.fightDuration / 1000 / 60)).toFixed(2)}</td></tr>
