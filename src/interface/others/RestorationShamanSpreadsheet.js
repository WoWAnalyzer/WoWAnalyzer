        ...
        <div style={{ padding: '0px 22px 15px 0px' }}>Please use the below table to populate the Restoration Shaman Spreadsheet. <a href="https://ancestralguidance.com/spreadsheet/">Link to the sheet</a><br /></div>
          <table style={styles.table} >
            <tbody>
              ...
              <tr><td>{parser._modules.surgingTides.surgingTideProcsPerMinute}</td></tr>
              <tr><td>{(parser._modules.spoutingSpirits.spoutingSpiritsHits / casts(SPELLS.SPIRIT_LINK_TOTEM.id) || getAbility(SPELLS.SPOUTING_SPIRITS_HEAL.id).healingHits / casts(SPELLS.SPIRIT_LINK_TOTEM.id) || 0).toFixed(2)}</td></tr>
