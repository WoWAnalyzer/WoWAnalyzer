...
export default (
  <NewsRegularArticle title="Time Filtering" publishedAt="2019-07-23" publishedBy={Zeboot}>
    ...
    preventing non-relevant events from contaminating the filtered data. <br />
    ...
    This change also has an impact on contributors in that the fight object has changed. In order to
    ensure future modules work as expected when the results are filtered, please take the time to
    read these small list of internal API changes: <br />
    ...
    on <a href="https://wowanalyzer.com/discord">Discord</a>!
    <br />
    <br />
