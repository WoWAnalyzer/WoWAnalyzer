...
export default {
  ...
  [bosses.TombOfSargeras.GOROTH]: [
    require('./Images/TombOfSargeras/Goroth.jpg'),
  ],
  [bosses.TombOfSargeras.DEMONIC_INQUISITION]: [
    require('./Images/TombOfSargeras/DemonicInquisition.jpg'),
  ],
  [bosses.TombOfSargeras.HARJATAN]: [
    require('./Images/TombOfSargeras/Harjatan.jpg'),
  ],
  [bosses.TombOfSargeras.MISTRESS_SASSZINE]: [
    require('./Images/TombOfSargeras/MistressSasszine.jpg'),
  ],
  [bosses.TombOfSargeras.SISTERS_OF_THE_MOON]: [
    require('./Images/TombOfSargeras/SistersOfTheMoon.jpg'),
  ],
  [bosses.TombOfSargeras.THE_DESOLATE_HOST]: [
    require('./Images/TombOfSargeras/TheDesolateHost.jpg'),
  ],
  [bosses.TombOfSargeras.MAIDEN_OF_VIGILANCE]: [
    require('./Images/TombOfSargeras/MaidenOfVigilance.jpg'),
  ],
  [bosses.TombOfSargeras.FALLEN_AVATAR]: [
    require('./Images/TombOfSargeras/FallenAvatar.jpg'),
  ],
  [bosses.TombOfSargeras.KILJAEDEN]: [
    require('./Images/TombOfSargeras/KilJaeden.jpg'),
  ],
};
