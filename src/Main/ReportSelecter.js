      ...
      <form onSubmit={this.handleSubmit} className="form-inline">
        ...
        <div className="panel">
          <div className="panel-body">
            ...
            Feature requests (<dfn data-tip="Provided that you're not using one of Microsoft's browsers.">and bug reports*</dfn>) are welcome! <i>@Zerotorescue</i> on <a href="https://discordapp.com/invite/hammerofwrath">Discord</a> or create an issue <a href="https://github.com/MartijnHols/HolyPaladinAnalyzer/issues">here</a>.
          </div>
        </div>
