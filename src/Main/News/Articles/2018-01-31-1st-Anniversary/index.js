    ...
    return (
      <Wrapper>
        ...
        <Item title="Restoration Druid 🍂" date="15 May">
          ...
          <Maintainer {...CONTRIBUTORS.greatman} /> contributored the initial Dreamwalker statistic.<br />
          <Maintainer {...CONTRIBUTORS.rubensayshi} /> introduced the concept of fixing bugs in Blizzard's combatlogs by re-ordering events. This concept evolved to "Events Normalizers" that we use today for fixing all sorts of weird combatlog bugs. He also improved a couple of features of the Resto Druid analyzer.<br />
          <Maintainer {...CONTRIBUTORS.sref} /> has done a lot of work on the Restoration Druid implementation and has added and improved a large part of the spec implementation.
        </Item>
        ...
        <Item title="Discipline Priest" date="19 May">
          ...
          This spec had a lot of people contributing code: <Maintainer {...CONTRIBUTORS.Zerotorescue} />, <Maintainer {...CONTRIBUTORS.Reglitch} />, <Maintainer {...CONTRIBUTORS.nutspanther} />, <Maintainer {...CONTRIBUTORS.Oratio} />, <Maintainer {...CONTRIBUTORS.Gao} />, <Maintainer {...CONTRIBUTORS.hassebewlen} />, and <Maintainer {...CONTRIBUTORS.milesoldenburg} />.
        </Item>

        <Item title="The first PR by an outside contributor!" date="19 May">
          Getting the first PR was very exciting! It meant someone else was interested enough in my project to dedicate time and effort towards improving it. <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/22">Our first PR</a> was created by <Maintainer {...CONTRIBUTORS.Reglitch} /> at 19 May 2017. In it he contributed an "editorconfig" file: "Fairly self explanatory, enforces consistency when multiple devs are working on the project.". It was merged a day later.<br /><br />

          <Image source={FirstPR} description="The first PR" /><br />

          <Maintainer {...CONTRIBUTORS.Reglitch} /> has done a lot more work since then, primarily on the Discipline Priest implementation. He is now a part of the WoWAnalyzer admin team.
        </Item>
        ...
        <Item title="A wild Discord server appeared!" date="24 May">
          ...
          While <Maintainer {...CONTRIBUTORS.blazyb} /> was working on developing the Resto Druid Analyzer he used a Discord server for feedback, updates, questions and requests. Seeing how well this worked led to making the shared <a href="https://discord.gg/AxphPxU">WoWAnalyzer Discord server</a> that we use today.<br /><br />
        ...
        <Item title="Mistweaver Monk" date="25 May">
          ...
          <span className="Monk">Mistweaver Monk</span> support was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/33">first proposed</a> by <Maintainer {...CONTRIBUTORS.Anomoly} /> at 23 May 2017, and merged to WoWAnalyzer.com after a short review process a day later. His reasoning for getting involved:<br /><br />
        ...
        <Item title="Restoration Shaman" date="28 May">
          ...
          Original support for Restoration Shaman was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/39">added</a> by <Maintainer {...CONTRIBUTORS.Versaya} />. He worked on this for a long time to make it into a big part of what it is today.<br /><br />

          <Image source={RestoShaman} description="Initial Restoration Shaman" /><br />

          <Maintainer {...CONTRIBUTORS.Versaya} /> also added the unique <b>feeding</b> tab. This shows the healing done by spells that feed into <SpellLink id={SPELLS.CLOUDBURST_TOTEM_TALENT.id} icon /> while it was up.<br /><br />

          <Image source={RestoShamanFeeding} description="The feeding tab" /><br />

          The spec had contributions from a couple of other contributors. <Maintainer {...CONTRIBUTORS.aryu} /> added the very interesting <SpellLink id={SPELLS.ANCESTRAL_VIGOR_TALENT.id} /> metric that shows amount of lives saved. <Maintainer {...CONTRIBUTORS.Anomoly} /> migrated the spec to the new WoWAnalyzer version so that it would become easier to maintain and added T21 2 set and 4 set. <Maintainer {...CONTRIBUTORS.Hartra344} /> later took over as maintainer of the spec and implemented the checklist as well as a bunch of other features.
        </Item>
        ...
        <Item title="Continuous deployment (and our first server)" date="2 Jun">
          ...
          <Maintainer {...CONTRIBUTORS.strel} /> guided me through setting up most of this initially; we wouldn't have this amazing setup without his help. Since the initial setup we have made some improvements, we will give more insight into our full setup in a future article.
        </Item>

        <Item title="Elemental Shaman" date="4 Jun">
          <SpecIcon spec={SPECS.ELEMENTAL_SHAMAN} />
          The initial version of Elemental Shaman was added by <Maintainer {...CONTRIBUTORS.fasib} />. This included cast efficiency, the cooldown tab only included <SpellLink id={SPELLS.ASCENDANCE_TALENT_ELEMENTAL.id} icon /> (if specced) and <SpellLink id={SPELLS.STORMKEEPER.id} icon />, and introduced two new things: a procs tab and a Maelstrom tab.<br /><br />
          ...
          <Maintainer {...CONTRIBUTORS.janvavra} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/469">contributed a couple of simple fixes</a> for Elemental Shamans using <SpellLink id={SPELLS.STORM_ELEMENTAL_TALENT.id} icon />. <Maintainer {...CONTRIBUTORS.HawkCorrigan} /> migrated Elemental Shaman's code to a new version of WoWAnalyzer and implemented a bunch of things such as T21, <ItemLink id={ITEMS.THE_DECEIVERS_BLOOD_PACT.id} icon /> and others.
        </Item>
        ...
        {/*<Item title="Development tab" date="25 Jun">
          86c6c930dd8a2a606055f47fa0a4793c314e907b
            ...
            By <Maintainer {...CONTRIBUTORS.Zerotorescue} />
        ...
        <Item title="Holy Priest" date="1 Jul">
          ...
          Holy Priest support was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/96">added</a> by <Maintainer {...CONTRIBUTORS.enragednuke} />. He says his motivation to add it was mostly a combination of watching <Maintainer {...CONTRIBUTORS.Reglitch} /> develop the Discipline Priest module (he was occasionally streaming development at the time) and a want to learn more JavaScript. And he just happened to play a spec not yet supported.<br /><br />

          <Image source={HolyPriest} description="The initial Holy Priest version" /><br />

          <Maintainer {...CONTRIBUTORS.Skamer} /> also contributed a couple of things to this spec, such as support for the <SpellLink id={SPELLS.DIVINITY_TALENT.id} icon />.
        </Item>
        ...
        <Item title="The WoWAnalyzer browser extension" date="19 Jul">
          <Maintainer {...CONTRIBUTORS.aryu} /> created a browser extension to make it easier to analyze your logs directly from Warcraft Logs. The extension adds the WoWAnalyzer logo to your browser toolbar that, when clicked on a valid WCL report, will allow you to analyze it directly with WoWAnalyzer.<br /><br />
        ...
        <Item title="Windwalker Monk" date="23 Jul">
          ...
          Initial support for the Windwalker Monk spec was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/129">added</a> by <Maintainer {...CONTRIBUTORS.AttilioLH} />. This included all the bootstrapping but not a lot of analysis.<br /><br />

          <Image source={WindwalkerMonk} description="The initial version of the Windwalker Monk" /><br />

          <Maintainer {...CONTRIBUTORS.mwwscott0} /> made a PR to add a bit more but decided not to go through with it. <Maintainer {...CONTRIBUTORS.Anomoly} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/381">added</a> a couple of things to provide better basic support before <Maintainer {...CONTRIBUTORS.Juko8} /> took over contributorship at 10 October 2017 and contributed most of what we have today. Some other minor contributions were done by <Maintainer {...CONTRIBUTORS.Coryn} /> who added an <SpellLink id={SPELLS.ENERGIZING_ELIXIR_TALENT.id} icon /> analyzer, and <Maintainer {...CONTRIBUTORS.Talby} /> who contributed a few minor miscellaneous improvements.
        </Item>

        <Item title="Guardian Druid 🐻" date="7 Aug">
          <SpecIcon spec={SPECS.GUARDIAN_DRUID} />
          Guardian Druid was the first supported tanking spec. It was originally <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/137">added</a> by <Maintainer {...CONTRIBUTORS.WOPR} /> with a bunch of new core tools useful for all tanking specs. Shortly after <Maintainer {...CONTRIBUTORS.faide} /> joined the Guardian Druid team adding a lot of useful analysis and cool new features such as the filler spell spam detection among many other things. <Maintainer {...CONTRIBUTORS.faide} /> took full ownership of the spec from September so that <Maintainer {...CONTRIBUTORS.WOPR} /> would be able to focus on Brewmaster.<br /><br />
        ...
        <Item title="Subtlety Rogue" date="11 Aug">
          ...
          <Maintainer {...CONTRIBUTORS.zealk} /> added the initial version for this spec. While the first pieces were <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/130">added</a> at 25 July 2017, it wasn't enabled until 11 August.<br /><br />

          <Image source={SubtletyRogue} description="The initial version of the Subtlety Rogue" /><br />

          From 19 November 2017 and onwards <Maintainer {...CONTRIBUTORS.tsabo} /> has taken over as the main maintainer of this spec's analysis. He has added <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pulls?utf8=✓&q=is%3Apr+Rogue">a lot of things</a> since then which is now most of what we have for the spec today.
        </Item>

        <Item title="Enhancement Shaman" date="14 Aug">
          <SpecIcon spec={SPECS.ENHANCEMENT_SHAMAN} />
          Enhancement Shaman support was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/145">added</a> by <Maintainer {...CONTRIBUTORS.Nighteyez07} />. Today's version is quite complete but hasn't received any significant changes since October and does not yet have support for new things such as tier 21 or the checklist. If you know Enhancement well enough, can program or want to learn how to program, and if you have the time and motivation to actually do it then please consider giving it a try! See <a href="https://github.com/WoWAnalyzer/WoWAnalyzer">GitHub</a> or ask in <a href="https://discord.gg/AxphPxU">Discord</a> for more information.<br /><br />
        ...
        <Item title="Affliction Warlock" date="18 Aug">
          <div className="clearfix">
            ...
            <Maintainer {...CONTRIBUTORS.Chizu} />'s accounting:
          </div>
        ...
        <Item title="Character and fight selection pull down menus" date="28 Aug">
          ...
          To improve this <Maintainer {...CONTRIBUTORS.fasib} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/200">added</a> the character and fight selection popover menus that we have today.<br /><br />

          <Image source={CharacterAndFightPullDownMenus} description="The character and fight selection popover menus" /><br />

          Later when <Maintainer {...CONTRIBUTORS.Zerotorescue} /> glued the navigation bar to the top of the browser viewport he introduced a bug where you could no longer scroll down the list and select the bottom few players. <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/issues/824">This still is an open issue.</a> If you'd like to see it fixed please consider <a href="https://github.com/WoWAnalyzer/WoWAnalyzer">making a pull request</a>!
        </Item>

        <Item title="Balance Druid" date="30 Aug">
          <SpecIcon spec={SPECS.BALANCE_DRUID} />
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/210">Added</a> by <Maintainer {...CONTRIBUTORS.Iskalla} />, later taken over by <Maintainer {...CONTRIBUTORS.Gebuz} />.<br /><br />
        ...
        <Item title="Destruction Warlock" date="2 Sep">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/231">Added</a> by <Maintainer {...CONTRIBUTORS.Chizu} /> after also doing Affliction Warlock. See Affliction Warlock's bit for his motiviation to start working on WoWAnalyzer.<br /><br />
        ...
        <Item title="Feral Druid" date="4 Sep">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/241">Added</a> by <Maintainer {...CONTRIBUTORS.Thieseract} />.<br /><br />
        ...
        <Item title="Blood Death Knight" date="6 Sep">
          <div className="clearfix">
            ...
            <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/247">Added</a> by <Maintainer {...CONTRIBUTORS.Yajinni} />:
          </div>
        ...
        <Item title="Havoc Demon Hunter" date="6 Sep">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/262">Added</a> by <Maintainer {...CONTRIBUTORS.Mamtooth} />.<br /><br />
        ...
        <Item title="Retribution Paladin" date="12 Sep">
          <div className="clearfix">
            ...
            Support for Retribution Paladin was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/293">added</a> by <Maintainer {...CONTRIBUTORS.Hewhosmites} />. His motivation for adding it:
          </div>
        ...
        <Item title="Demonology Warlock" date="17 Sep">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/315">Added</a> by <Maintainer {...CONTRIBUTORS.Chizu} /> after also doing Affliction and Destruction Warlock analyzers. See Affliction Warlock's bit for his motiviation to start working on WoWAnalyzer.<br /><br />
        ...
        <Item title="Protection Warrior" date="23 Sep">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/363">Added</a> by <Maintainer {...CONTRIBUTORS.Salarissia} />.<br /><br />
        ...
        <Item title="Frost Mage" date="11 Oct">
          <div className="clearfix">
            ...
            <Maintainer {...CONTRIBUTORS.Sharrq} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/468">added</a> initial support for Frost Mages. His motivation was as follows:<br /><br />
          </div>
          ...
          <Maintainer {...CONTRIBUTORS.sref} /> has also done a considerable amount of work on this spec.
        </Item>
        ...
        <Item title="Checking legendary item levels" date="14 Oct">
          To help you notice legendaries you forgot to upgrade, <Maintainer {...CONTRIBUTORS.Fyruna} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/506">added</a> a suggestion for legendaries below the max possible item level.<br /><br />
        ...
        <Item title="Implemented accurate stat tracking" date="14 Oct">
          <Maintainer {...CONTRIBUTORS.sref} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/520">implemented</a> a module for accurate stat rating tracking. This is a utility module intended to track the selected player's current stat rating at any point in the fight.<br /><br />
        ...
        <Item title="Always be moving? 💃🕺" date="15 Oct">
          ...
          <Maintainer {...CONTRIBUTORS.Fyruna} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/522">added</a> this distance moved statistic.<br /><br />
          ...
          The initial version was bugged as it included the distance moved of other players. This was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/issues/551">spotted</a> by <Maintainer {...CONTRIBUTORS.Chizu} />. This was quickly <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/commit/f674f68a418d16dbc1612ada2ae43f1c22babae9">fixed</a> by <Maintainer {...CONTRIBUTORS.Zerotorescue} />.<br /><br />

          <Maintainer {...CONTRIBUTORS.janvavra} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/689">added</a> a <i>time spent moving</i> indicator relative to fight duration. This is meant to be a better indicator of time wasted by movement.<br /><br />
        ...
        <Item title="Fire Mage" date="16 Oct">
          ...
          Initial version was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/521">added</a> by <Maintainer {...CONTRIBUTORS.Fyruna} />. <Maintainer {...CONTRIBUTORS.sref} /> added a couple of things. <Maintainer {...CONTRIBUTORS.Sharrq} /> added a lot of modules.<br /><br />
        ...
        <Item title="Arms Warrior" date="20 Oct">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/571">Added</a> by <Maintainer {...CONTRIBUTORS.TheBadBossy} />.<br /><br />
        ...
        <Item title="Unholy Death Knight" date="23 Oct">
          <div className="clearfix">
            ...
            <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/602">Added</a> by <Maintainer {...CONTRIBUTORS.Khazak} />, his motivation:<br /><br />
          </div>
        ...
        <Item title="Beast Mastery Hunter" date="29 Oct">
          <div className="clearfix">
            ...
            <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/681">Added</a> by <Maintainer {...CONTRIBUTORS.Putro} />. His motivation for adding it:<br /><br />
          </div>
        ...
        <Item title="Frost Death Knight" date="2 Nov">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/712">Added</a> by <Maintainer {...CONTRIBUTORS.Bonebasher} />.<br /><br />
        ...
        <Item title="Automatic fight and player selection" date="4 Nov">
          <Maintainer {...CONTRIBUTORS.Gao} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/729">improved</a> the report selector to automatically select the fight and player if they were selected in the Warcraft Logs report. This should make analyzing from Warcraft Logs reports a bit quicker.
        </Item>

        <Item title="Spell timelines" date="5 Nov">
          To give better insight into cooldown usage, <Maintainer {...CONTRIBUTORS.Zerotorescue} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/740">added</a> a spell timeline that shows when a spell goes on cooldown, how long it was on cooldown and when it became available again. This overview makes it a lot easier to visualize your cast efficiency and understand it.<br /><br />
          ...
          A few days later <Maintainer {...CONTRIBUTORS.Zerotorescue} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/783">added</a> the timeline tab. This serves as an overview of all your spell cooldowns and helps spot moments where you could have cast stronger abilities.<br /><br />

          <Image source={SpellTimeline} description="A timeline of all spells and their cooldowns" wide /><br />

          <Maintainer {...CONTRIBUTORS.sref} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/843">added</a> the white indicators that show when a spell gains an extra charge.
        </Item>
        ...
        <Item title="Improved error messages" date="8 Nov">
          In an effort to improve the information when an error occurs <Maintainer {...CONTRIBUTORS.Zerotorescue} /> reworked most of the error messages to be much more informative and less boring. One such instance is when the API is down due to it being updated, although you'll likely never see that again since our downtime while rolling out updates is now usually no more than a (few) second(s). I guess all that work was for nothing.<br /><br />
        ...
        <Item title="Don't forget to equip 2 legendaries" date="10 Nov">
          ...
          Next boss/raid you're good though since <Maintainer {...CONTRIBUTORS.Gao} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/780">added</a> a suggestion that detects this and lets you know. Phew!<br /><br />
        ...
        <Item title="Protection Paladin" date="11 Nov">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/781">Added</a> by <Maintainer {...CONTRIBUTORS.Yajinni} /> and <Maintainer {...CONTRIBUTORS.Noichxd} />.<br /><br />
        ...
        <Item title="A big info box for specs that aren't maintained" date="12 Nov">
          <Maintainer {...CONTRIBUTORS.Zerotorescue} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/785">added</a> a large information box to specs that are not actively maintained. This serves as a warning that the spec's analysis might not be useful and/or accurate and we hope that the rest of the specs that are actually good will not be judged by the accuracy of the incomplete specs.<br /><br />
        ...
        <Item title="Using the time on cooldown for cast efficiency" date="12 Nov">
          <Maintainer {...CONTRIBUTORS.sref} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/799">changed</a> the basis for cast efficiency into the time on cooldown as recorded by the <i>spell usable</i> module (the cooldown tracker mentioned earlier). This should increase the accuracy.
        </Item>
        ...
        <Item title="Frontpage reworked" date="28 Nov">
          <Maintainer {...CONTRIBUTORS.Zerotorescue} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/882">released</a> a reworked frontpage.<br /><br />

          <Image source={Frontpage20} description="The new frontpage upon release." />
        </Item>

        <Item title="Stats on pull" date="30 Nov">
          <Maintainer {...CONTRIBUTORS.Zerotorescue} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/890">added</a> a much requested feature: a stats on pull panel.<br /><br />
        ...
        <Item title="Google's translation disabled to fix crashes" date="7 Dec">
          While monitoring our error logs we've been noticing a lot of <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/issues/948">weird errors</a> that we could not reproduce. After some investigating <Maintainer {...CONTRIBUTORS.Zerotorescue} /> discovered that this was caused by a bug in React 16 (the most important third party library we use) when the app is opened with Google translator (Google Chrome does this automatically if configured). This is not an issue that would be easy for us to fix, and realistically there is nothing we can do about it to prevent crashes.<br /><br />
        ...
        <Item title="Checking your items for proper enchants" date="14 Dec">
          It's easy to overlook simple things like enchants, but it's free throughput that you should get for optimal performance. <Maintainer {...CONTRIBUTORS.Khazak} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/974">added</a> a suggestion that checks for missing enchants and one that checks for poor quality enchants.<br /><br />

          <Maintainer {...CONTRIBUTORS.Putro} /> also <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1072">added</a> support for Warlords of Draenor cloak enchants which are regularly used due to the massive power disparity between secondary and primary stats.<br /><br />
        ...
        <Item title="Fury Warrior" date="14 Dec">
          ...
          <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/982">Added</a> by <Maintainer {...CONTRIBUTORS.Maldark} />.<br /><br />
        ...
        <Item title="Death tracking" date="28 Dec">
          <Maintainer {...CONTRIBUTORS.Sharrq} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1066">added</a> a module that tracks player deaths and resurrections, calculates the time spent dead, has a suggestion for avoiding damage and recommends using defensives.<br /><br />
        ...
        <Item title="Casting time bar in the spell timeline tab" date="2 Jan">
          While not a major change, this has shown to be incredibly useful for visualizing your downtime. A great bonus is that is greatly helps us to find and fix bugs in the gcd/channel time displays. <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1050">Added</a> by <Maintainer {...CONTRIBUTORS.Zerotorescue} />.<br /><br />
        ...
        <Item title="Nekorsis added a gear tab" date="2 Jan">
          <Maintainer {...CONTRIBUTORS.Nekorsis} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1017">added</a> a gear tab to show what gear you have equipped. Unfortunately the Warcraft Logs API does not provide item names and since we also do not have a complete item database we are unable to show item names.<br /><br />
        ...
        <Item title="You're looking at it! Added a news system" date="8 Jan">
          A simple news system to write articles was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1154">added</a> by <Maintainer {...CONTRIBUTORS.Zerotorescue} />. We'll try to keep you updated about interesting developments.
        </Item>
        ...
        <Item title="Survival Hunter" date="18 Jan">
          ...
          With both Beast-Mastery and Marksmanship modules being close to completed, <Maintainer {...CONTRIBUTORS.Putro} /> began work on the Survival module in early 2018. It was <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1202">merged</a> 18 January.<br /><br />
        ...
        <Item title="Assassination Rogue" date="18 Jan">
          ...
          <Maintainer {...CONTRIBUTORS.tsabo} /> <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/pull/1227">added</a> basic support for the Assassination Rogue spec.<br /><br />
  ...
  render() {
    return (
      <RegularArticle bodyStyle={{ position: 'relative', overflow: 'hidden' }} {...this.props}>
        ...
        The project was started by <Maintainer {...CONTRIBUTORS.Zerotorescue} /> (a <span className="Paladin">Holy Paladin</span> theorycrafter) to do additional analysis to help with theorycrafting. Since it took several months before other contributors joined the project, the first half of the recap will be written from his point of view.<br /><br />
