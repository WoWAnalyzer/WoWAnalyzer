    ...
    <Timeline>
      <div className="panel">
        ...
        <div className="panel-body">
          ...
          For a long time this seemed impossible to accurately calculate based on a log, but after a night of going through Warcraft Logs' replay function to estimate my own Mastery Effectiveness, I realized that it must have access to a player's location to be able to show the replay like it does. After some figuring out I got a proof of concept working, which became the <a href="https://github.com/WoWAnalyzer/WoWAnalyzer/commit/bd7971995fe16d14aec7286765c13c2984c44d76" target="_blank" rel="noopener noreferrer">first commit</a> at <b>31 Jan 2017 00:02 CET</b>. I named project "Holy Paladin mastery effectiveness calculator" at the time because that was all it did.
