...
export default {
  descriptions: {
    ...
    [SPELLS.PURGE_THE_WICKED_TALENT.id]: <span>Cleanses the target with fire, causing (100% of Spell power) Fire damage and an additional (500% of Spell power) Fire damage over 20 sec. Spreads to an additional nearby enemy when you cast Penance on the target.</span>,
    ...
    [SPELLS.EVANGELISM_TALENT.id]: <span>Extends the duration of all of your active Atonements by 7 sec.</span>,
},
