...
export default [
	...
	{
		date: new Date('2017-18-09'),
		changes: 'Added in the Tier 21 Modules',
		contributors: [Hewhosmites],
	},
	{
		date: new Date('2017-14-09'),
	...
	{
		date: new Date('2017-28-08'),
		changes: 'Added a Blade of Wrath proc tracker.',
		contributors: [Hewhosmites],
	},
	{
		date: new Date('2017-22-08'),
	...
	{
		date: new Date('2017-18-08'),
		changes: `Added a Holy Power Tracker and Graph.`,
		contributors: [Hewhosmites],
	},
	{
		date: new Date('2017-16-08'),
	...
	{
		date: new Date('2017-15-08'),
		changes: `Added a Tier 20 2 peice Module.`,
		contributors: [Hewhosmites],
	},
	{
		date: new Date('2017-13-08'),
