  ...
  suggestions(when) {
    ...
    when(strikeEfficiency).isLessThan(0.80)
        .addSuggestion((suggest, actual, recommended) => {
          return suggest(<span>You are casting <SpellLink id={SPELLS.FESTERING_STRIKE.id}/> too often.  Remember to cast <SpellLink id={SPELLS.SCOURGE_STRIKE.id}/> instead to dump runes on targets with more than four stacks of <SpellLink id={SPELLS.FESTERING_WOUND.id}/></span>)
