        ...
        <table className="data-table">
          ...
          <tbody>
            {generated && generated
              ...
              {/*<tr> this will add totals to the bottom of the table if its ever wanted
                <td style={{ width: '30%' }}> Total: </td>
                <td style={{ width: 50, paddingRight: 5, textAlign: 'right' }}> {totalGenerated} </td>
                <td style={{ width: '40%' }}/> 
                <td style={{ width: 50, paddingRight: 5, textAlign: 'right' }}> {totalWasted} </td>
                <td />
              </tr>*/}              
          </tbody>
        </table>
