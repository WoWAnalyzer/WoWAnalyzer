...
export default  [
  ...
  },
  {
    ...
    changes: <Wrapper><SpellLink id={SPELLS.SCOURGE_OF_WORLDS.id} />, <ItemLink id={ITEMS.COLD_HEART.id} icon />, and <SpellLink id={SPELLS.UNHOLY_FRENZY_BUFF.id} /> trackers added</Wrapper>,
    contributors: [Khazak],
  },
  {
