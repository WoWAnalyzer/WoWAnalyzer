...
class Tier21_2set extends Analyzer {
  ...
  constructor(...args) {
    super(...args);
    this.active = this.selectedCombatant.hasBuff(SPELLS.FROST_MAGE_T21_2SET_BONUS_BUFF.id);
  }
  ...
  item() {
    return {
      ...
      title: <SpellLink id={SPELLS.FROST_MAGE_T21_2SET_BONUS_BUFF.id} icon={false} />,
