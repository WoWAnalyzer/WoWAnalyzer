...
class MKIIGyroscopicStabilizer extends Analyzer {
  ...
  item() {
    return {
      ...
      result: <Wrapper>This allowed you to move while casting {this.usedBuffs} <SpellLink id={SPELLS.AIMED_SHOT.id} icon children="Aimed Shots" /> throughout the fight, these <SpellLink id={SPELLS.AIMED_SHOT.id} icon children="Aimed Shots" /> also had 15% increased crit chance.</Wrapper>,
    };
  }
}
