...
class MKIIGyroscopicStabilizer extends Analyzer {
  ...
  item() {
    return {
      ...
      result: <Wrapper>This allowed you to move while casting {this.usedBuffs} <SpellLink id={SPELLS.AIMED_SHOT.id} /> throughout the fight, these <SpellLink id={SPELLS.AIMED_SHOT.id} />s also had 15% increased crit chance.</Wrapper>,
    };
  }
}
