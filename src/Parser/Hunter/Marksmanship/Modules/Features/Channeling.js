...
class Channeling extends CoreChanneling {
  ...
  on_byPlayer_cast(event) {
    ...
    if (event.ability.guid === SPELLS.RAPID_FIRE_TICKS.id) {
  ...
  cancelChannel(event, ability) {
    if (this.isChannelingSpell(SPELLS.BARRAGE_TALENT.id) || this.isChannelingSpell(SPELLS.RAPID_FIRE_TICKS.id)) {
  ...
  on_byPlayer_removebuff(event) {
    ...
    if (!this.isChannelingSpell(SPELLS.RAPID_FIRE_TICKS.id)) {
