        ...
        footer={(
          <div className="statistic-bar">
            ...
            <div
              ...
              data-tip={`<b>${formatPercentage(this.buggedTicks / this.totalPossibleTicks)}%</b> of your expected Sentinel ticks bugged and didn't happen. This bug can somewhat be circumvented by not casting any spells right before you're meant to get a proc (every 6 seconds after cast).`}
            >
            </div>
          </div>
        )}
