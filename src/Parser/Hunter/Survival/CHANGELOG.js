...
export default [
  ...
  },
  {
    ...
    changes: <React.Fragment>Adds a <SpellLink id={SPELLS.ASPECT_OF_THE_EAGLE.id} /> module to provide suggestions with poor usage, and also updates <SpellLink id={SPELLS.MOKNATHAL_TACTICS.id} /> module to be more accurate when displaying refreshes.</React.Fragment>,
    contributors: [Putro],
  },
  {
