...
export default {
  ...
  description: (
    <div>
      Hey, I've been hard at work to make this analyzer as good as we can. You'll notice a lot of things are still missing, and these will be included as time passes as I work on getting everything in this analyzer module up to scratch. <br />
  ...
  specDiscussionUrl: 'https://github.com/WoWAnalyzer/WoWAnalyzer/milestone/22',
