    ...
    new Rule({
      ...
      requirements: () => {
        ...
        return [
          ...
          new Requirement({
            name: <Wrapper><SpellLink id={SPELLS.KILLER_COBRA_TALENT.id} icon /> and <ItemLink id={ITEMS.QAPLA_EREDUN_WAR_ORDER.id} /></Wrapper>,
          ...
          new Requirement({
            name: <Wrapper><SpellLink id={SPELLS.ASPECT_OF_THE_WILD.id} icon /> gained from <ItemLink id={ITEMS.CALL_OF_THE_WILD.id} /></Wrapper>,
