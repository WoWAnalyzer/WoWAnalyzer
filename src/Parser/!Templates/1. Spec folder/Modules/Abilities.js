...
class Abilities extends CoreAbilities {
  spellbook() { // TODO: Migrate
    ...
    return [
       ...
       * required cooldown {func} A function to calculate the cooldown of a spell. Parameters provided: `hastePercentage`, `selectedCombatant`
       ...
       * optional suggestion {bool} If this is set to `true`, this spell will trigger a suggestion and can be improved in the cast efficiency tab.
