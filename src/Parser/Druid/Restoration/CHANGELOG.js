...
export default [
  {
    ...
    changes: <Wrapper>Fixed a bug that could cause incorrect proc counts and uptimes for players using <SpellLink id={SPELLS.INCARNATION_TREE_OF_LIFE_TALENT.id} /> and <ItemLink id={ITEMS.CHAMELEON_SONG.id} /> together.</Wrapper>,
    contributors: [sref],
  },
  {
  ...
  },
  {
    ...
    changes: <Wrapper>Fixed a bug in <SpellLink id={SPELLS.CLEARCASTING_BUFF.id} /> Util module where overwritten procs weren't shown if player doesn't take <SpellLink id={SPELLS.MOMENT_OF_CLARITY_TALENT_RESTORATION.id} />.</Wrapper>,
    contributors: [sref],
  },
  {
