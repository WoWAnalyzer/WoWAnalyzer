    ...
    return (
      <RuleContext.Provider value={this.setRequirementPerformance}>
        <div className={`expandable ${this.state.expanded ? 'expanded' : ''}`}>
          ...
          <div className="details" style={{ display: this.state.expanded ? undefined : 'none', paddingLeft: 65, position: 'relative', minHeight: 80 }}>
            {description && (
              <React.Fragment>
                <InformationIcon style={{ position: 'absolute', top: 15, left: 18, fontSize: '2em' }} />
