      ...
      render: () => (
        <div>
          ...
          <div style={{ padding: '10px 0 15px' }}>
            <SoulShardBreakdown
              shardsGained = {this.owner.modules.soulShardTracker.gained}
              shardsSpent = {this.owner.modules.soulShardTracker.spent}
              shardsWasted = {this.owner.modules.soulShardTracker.wasted}
            />
          </div>
        </div>
      ),
