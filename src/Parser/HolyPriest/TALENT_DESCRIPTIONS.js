...
export default {
  descriptions: {
    [SPELLS.TRAIL_OF_LIGHT_TALENT.id]: <span>When you cast Flash Heal, 40% of the healing is replicated to the previous target you healed with Flash Heal.</span>,
    ...
    [SPELLS.GUARDIAN_ANGEL_TALENT.id]: <span>When Guardian Spirit expires without saving the target from death, reduce its remaining cooldown to 90 seconds.</span>,
    ...
    [SPELLS.PIETY_TALENT.id]: <span>The cooldown of Prayer of Mending is reduced by 2 sec, and it now triggers Serendipity, reducing the remaining cooldown on Holy Word: Sanctify.</span>,
    ...
    [SPELLS.BENEDICTION_TALENT.id]: <span>Your Prayer of Mending has a 40% chance to leave a Renew on each target it heals.</span>,
