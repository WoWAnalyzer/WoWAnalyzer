...
class Tier20_2set extends Analyzer {
  ...
  constructor(...args) {
    super(...args);
    this.active = this.selectedCombatant.hasBuff(SPELLS.ENHANCE_SHAMAN_T20_2SET_EQUIP.id);
  }

  item() {
    const T202setUptime = this.selectedCombatant.getBuffUptime(SPELLS.ENHANCE_SHAMAN_T20_2SET_BONUS_BUFF.id) / this.owner.fightDuration;
    return {
