...
class T21_2P extends Analyzer {
  ...
  constructor(...args) {
    super(...args);
    this.active = this.selectedCombatant.hasBuff(SPELLS.ASSA_ROGUE_T21_2SET_BONUS.id);
  }
  ...
  item() {
    return {
      ...
      title: <SpellLink id={SPELLS.ASSA_ROGUE_T21_2SET_BONUS_BUFF.id} icon={false} />,
      result: (
        <dfn data-tip="Ideally you should be aiming for somewhere around 80% uptime. This should, most of the time, naturally happen in the process of clipping your Envenom debuff; do not chase higher uptime on this at the expense of your regular rotation.">
          {formatPercentage(this.percentUptime)}% <SpellLink id={SPELLS.ASSA_ROGUE_T21_2SET_BONUS_BUFF.id} /> uptime
        </dfn>
      ),
    };
  }
