...
export default {
  ...
  <div>
    ...
    While the spec is built out, please head over to the <a href="https://discord.gg/0dkfBMAxzTkWj21F" target="_blank" rel="noopener noreferrer">Peak of Serenity</a> discord server for any questions or feeback. You can reach me there as Anomoly. Thank you and thanks for understanding as we build at this spec.
  </div>
  ),
