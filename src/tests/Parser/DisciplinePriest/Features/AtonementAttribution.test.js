...
import { TwoSuccesiveDamagingEventsWithAtonementOnSelfBetween } from '../Fixtures/ReorderingScenarios';
...
describe('DisciplinePriest.Reordering', () => {
  ...
  it('Two Succesive Damaging Events with atonement on self between reordered', () => {
