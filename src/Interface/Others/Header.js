        ...
        <div className="container image-overlay">
          <div className="row">
            <div className="col-lg-6 col-md-10">
              <h1><Trans>Prepatch WoW&shy;Analyzer</Trans></h1>
              ...
              <div style={{ fontSize: '1.2em', fontWeight: 600, marginTop: 5 }} className={`alert alert-info`}>
                Welcome to the WoWAnalyzer for the Battle for Azeroth Prepatch. <a href="https://wowanalyzer.com">Click here</a> to switch to today's version.
              </div>
