...
class LingeringRadiance extends Analyzer {
  healingDone = 0;
  damageDone = 0;

  constructor(args: Options) {
    super(args);
    this.active = this.selectedCombatant.hasTalent(TALENTS.LINGERING_RADIANCE_TALENT);
  ...
  statistic() {
    return (
      ...
      >
        <TalentSpellText talent={TALENTS.LINGERING_RADIANCE_TALENT}>
...
export default LingeringRadiance;
