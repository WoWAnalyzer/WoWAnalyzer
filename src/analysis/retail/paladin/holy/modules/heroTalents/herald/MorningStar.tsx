...
class MorningStar extends Analyzer {
  healingDone = 0;
  damageDone = 0;

  constructor(args: Options) {
    super(args);
    this.active = this.selectedCombatant.hasTalent(TALENTS.MORNING_STAR_TALENT);
  ...
  statistic() {
    return (
      ...
      >
        <TalentSpellText talent={TALENTS.MORNING_STAR_TALENT}>
