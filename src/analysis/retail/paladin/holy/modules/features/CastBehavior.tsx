...
class CastBehavior extends Analyzer {
  ...
  iolCastRatioChart() {
    ...
    const holyLight = getAbility(TALENTS.HOLY_LIGHT_HOLY_TALENT.id);
    const holyShockCast = getAbility(TALENTS.HOLY_SHOCK_HOLY_TALENT.id);
    ...
    const items = [
      ...
      {
        color: '#F57C00',
        label: TALENTS.HOLY_LIGHT_HOLY_TALENT.name,
        spellId: TALENTS.HOLY_LIGHT_HOLY_TALENT.id,
        value: iolHolyLights,
      },
      {
        color: '#A93226',
