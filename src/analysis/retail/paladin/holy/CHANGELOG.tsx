...
export default [
  change(date(2026, 7, 17), <>Reworked the <SpellLink spell={SPELLS.JUDGMENT_CAST_HOLY} /> section. It is a filler cast for damage rather than a high priority heal, so it is no longer graded on cast efficiency -- the best logs deliberately cast it well below the maximum.</>, Taleria),
  change(date(2026, 7, 17), <>Added a <SpellLink spell={SPELLS.HOLY_LIGHT} /> section to the overview, showing how many extra allies each cast reached through <SpellLink spell={TALENTS_PALADIN.RESPLENDENT_LIGHT_TALENT} /> and what that healed for.</>, Taleria),
