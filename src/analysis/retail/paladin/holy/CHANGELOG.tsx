...
export default [
  ...
  change(date(2026, 7, 17), <>Reworked the <SpellLink spell={SPELLS.JUDGMENT_CAST_HOLY} /> section. It is a filler cast for damage and <ResourceLink id={RESOURCE_TYPES.HOLY_POWER.id} /> rather than a high priority heal, so it now reports those instead of being graded on cast efficiency.</>, Taleria),
