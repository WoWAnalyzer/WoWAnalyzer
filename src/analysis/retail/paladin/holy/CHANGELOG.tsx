...
export default [
  change(date(2026, 9, 1), <>Fixed overcounting of <SpellLink spell={TALENTS_PALADIN.INFUSION_OF_LIGHT_TALENT} /> procs with <SpellLink spell={TALENTS_PALADIN.INFLORESCENCE_OF_THE_SUNWELL_TALENT} />, counted <SpellLink spell={SPELLS.HAMMER_OF_WRATH_CAST} /> as a spender instead of reporting its casts as expired charges, and removed non-functional overcap detection.</>, Gnuminator),
