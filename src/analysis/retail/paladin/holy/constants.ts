...
export const ABILITIES_AFFECTED_BY_MASTERY = [
  ...
  TALENTS.HOLY_LIGHT_HOLY_TALENT.id,
  TALENTS.BESTOW_FAITH_HOLY_TALENT.id,
];
...
export const BEACON_TRANSFERING_ABILITIES = {
  ...
  [TALENTS.HOLY_LIGHT_HOLY_TALENT.id]: 1,
  [TALENTS.BESTOW_FAITH_HOLY_TALENT.id]: 1,
};
...
export const BEACON_TYPES = {
  BEACON_OF_FATH: TALENTS.BEACON_OF_FAITH_HOLY_TALENT.id,
  GLIMMER_OF_LIGHT_TALENT: SPELLS.BEACON_OF_LIGHT_CAST_AND_BUFF.id,
  BEACON_OF_VIRTUE: TALENTS.BEACON_OF_VIRTUE_HOLY_TALENT.id,
};
