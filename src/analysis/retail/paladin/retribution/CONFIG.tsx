...
const config: Config = {
  ...
  description: (
    <>
      <p>We hope you get some use out this analyzer we have been working on.</p>
      <p>
      ...
      <p>
        ...
        <a
          href="https://discord.com/invite/hammerofwrath"
          target="_blank"
        ...
        interrogations in <kbd>#ret-questions</kbd> and the <kbd>#ret-general</kbd> has lots of
      ...
      <p>
        ...
        <a href="http://www.icy-veins.com/wow/retribution-paladin-pve-dps-guide">Icy Veins</a>.
        These guides also feature encounter specific tips to help you improve. Look for them in the
