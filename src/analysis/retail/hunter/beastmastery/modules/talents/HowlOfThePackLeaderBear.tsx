...
class HowlOfThePackLeaderBear extends Analyzer {
  damage = 0;
  ...
  constructor(options: Options) {
    ...
    this.addEventListener(
      Events.summon.by(SELECTED_PLAYER).spell(SPELLS.HOWL_OF_THE_PACKLEADER_BEAR_SUMMON),
      this.onSummon,
    );
  }
  ...
  statistic() {
    return (
      ...
      >
        <BoringSpellValueText spell={SPELLS.HOWL_OF_THE_PACKLEADER_BEAR_SUMMON}>
...
export default HowlOfThePackLeaderBear;
