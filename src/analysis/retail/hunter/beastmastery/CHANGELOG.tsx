...
export default [
  change(date(2022, 11, 1), 'Updated all Beast Mastery modules for Dragonflight', Arlie),
  ...
  change(date(2021, 10, 31), <> Fix a bug with <SpellLink id={TALENTS.KILLER_INSTINCT_TALENT.id}/> that showed there were 0 casts in execute. </>, Putro),
  ...
  change(date(2020, 12, 19), <> Fixed an issue where <SpellLink id={TALENTS.BARRAGE_TALENT.id} /> wouldn't show as channeling in the timeline tab.</>, Putro),
