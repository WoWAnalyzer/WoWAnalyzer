...
const config: Config = {
  ...
  // The path to the current directory (relative from project root). This is used for generating a GitHub link directly to your spec's code.
