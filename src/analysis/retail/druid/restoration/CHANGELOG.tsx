...
export default [
  ...
  change(date(2022, 6, 9), <>Fixed handling of <SpellLink id={TALENTS_DRUID.PHOTOSYNTHESIS_RESTORATION_TALENT.id} /> to count <SpellLink id={SPELLS.ADAPTIVE_SWARM.id} /> in increase HoT rate and to work properly with <SpellLink id={SPELLS.THE_DARK_TITANS_LESSON.id} />. Also cleaned up the tooltip and made some minor fixes to spell lists.</>, Sref),
  ...
  change(date(2021, 6, 14), <>Fixed a bug where a hardcast <SpellLink id={TALENTS_DRUID.FLOURISH_RESTORATION_TALENT.id} /> could be counted as part of a Convoke if cast immediately before or after the Convoke.</>, Sref),
  ...
  change(date(2021, 6, 14), <>Updated <SpellLink id={TALENTS_DRUID.SOUL_OF_THE_FOREST_RESTORATION_TALENT.id} /> stat to properly account for Convoke, to better account for edge case issues, and updated the tooltip.</>, Sref),
  change(date(2021, 6, 6), <>Fixed an issue where <SpellLink id={TALENTS_DRUID.ABUNDANCE_RESTORATION_TALENT.id} /> related items were referenced in the Regrowth stat box even when the player doesn't have the talent.</>, Sref),
  ...
  change(date(2021, 5, 18), <>Added an entry for <SpellLink id={TALENTS_DRUID.FLOURISH_RESTORATION_TALENT.id} /> on the Cooldowns tab</>, Sref),
  ...
  change(date(2021, 5, 8), <>Cleaned up <SpellLink id={TALENTS_DRUID.FLOURISH_RESTORATION_TALENT.id} /> module and improved its attribution to be better in some edge cases.</>, Sref),
