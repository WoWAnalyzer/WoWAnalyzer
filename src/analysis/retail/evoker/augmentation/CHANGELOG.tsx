...
export default [
  ...
  change(date(2024, 12, 25), <>Add <SpellLink spell={TALENTS.REVERBERATIONS_TALENT}/> damage to Molten Embers statistics</>, Vollmer),
  ...
  change(date(2024, 11, 26), <>Update multipliers for Molten Embers module & add guide section</>, Vollmer),
  ...
  change(date(2024, 7, 18), <>Add Molten Embers module</>, Vollmer),
];
