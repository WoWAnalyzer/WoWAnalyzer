...
export const MOLTEN_EMBERS_MULTIPLIER = 0.15;
...
// Tier
export const MID1_AUGMENTATION_2PC_DAMAGE_MULTIPLIER = 0.15;
export const MID1_AUGMENTATION_2PC_EXTENSION_MODIFIER = 250;
export const MID1_AUGMENTATION_4PC_DAMAGE_MULTIPLIER = 0.2;
export const MID1_AUGMENTATION_4PC_CDR_MULTIPLIER = 1.2;
