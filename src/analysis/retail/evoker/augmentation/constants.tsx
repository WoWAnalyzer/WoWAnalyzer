...
export const DUPLICATE_EBON_MIGHT_MULTIPLIER = 0.75;
export const DUPLICATE_PERSONAL_DAMAGE_MULTIPLIER = 0.25;
export const NOZDORMU_ADEPT_PRESCIENCE_MULTIPLIER = 1 / 3;
export const DOUBLE_TIME_EBON_MIGHT_MULTIPLIER = 0.5;
export const MIGHTY_INFERNO_DAMAGE_MULTIPLIER = 0.4;
export const INFERNOS_BLESSING_BASE_DURATION_MS = 8000;
export const MAX_SKIP_CDR_BASE = 20000;
...
// Tier
export const MID1_AUGMENTATION_2PC_DAMAGE_MULTIPLIER = 0.1;
export const MID1_AUGMENTATION_2PC_EXTENSION_MODIFIER = 100;
export const MID1_AUGMENTATION_4PC_DAMAGE_MULTIPLIER = 0.1;
export const MID1_AUGMENTATION_4PC_CDR_MULTIPLIER = 1.1;
export const MID2_AUGMENTATION_4PC_DAMAGE_MULTIPLIER = 2;
