...
// Tier
export const T35_AUGMENTATION_2PC_DAMAGE_MULTIPLIER = 0.15;
export const T35_AUGMENTATION_2PC_EXTENSION_MODIFIER = 500;
export const T35_AUGMENTATION_4PC_DAMAGE_MULTIPLIER = 0.2;
export const T35_AUGMENTATION_4PC_CDR_MULTIPLIER = 1.2;
