  ...
  return (
    <SubSection title="Breath of Eons">
      <p>
        ...
        <SpellLink spell={TALENTS.TIME_SKIP_TALENT} /> should be used to reduce the cooldown of your
        empowers, <SpellLink spell={SPELLS.FIRE_BREATH} /> and <SpellLink spell={SPELLS.UPHEAVAL} />{' '}
        to maximize the amount of <SpellLink spell={SPELLS.SHIFTING_SANDS_BUFF} /> buffs you have
        active.
        <br />
        <br />
        ...
        <SpellLink spell={TALENTS.BREATH_OF_EONS_TALENT} /> window. Problem points such as: letting{' '}
        <SpellLink spell={TALENTS.EBON_MIGHT_TALENT} /> drop during your{' '}
