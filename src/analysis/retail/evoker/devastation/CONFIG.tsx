import { Baumritter, Vollmer } from 'CONTRIBUTORS';
...
const config: Config = {
  ...
  contributors: [Vollmer, Baumritter],
  ...
  exampleReport:
    '/report/jmwJLRdYgZH7XtFq/7-Heroic+Imperator+Averzian+-+Kill+(5:35)/83-Bellarys/standard',
