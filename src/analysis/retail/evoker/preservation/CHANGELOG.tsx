...
export default [
  change(date(2023, 1, 20), <>Add <SpellLink id={TALENTS_EVOKER.EMERALD_COMMUNION_TALENT}/> module for <SpellLink id={TALENTS_EVOKER.LIFEBIND_TALENT}/> ramp suggestion</>, Trevor),
