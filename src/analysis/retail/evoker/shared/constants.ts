...
export const TEMORAL_BURST_CDR_MODIFIER_PER_STACK = 0.01;
export const TIME_CONVERGENCE_INT_MULTIPLIER = 0.05;
...
export const IMMINENT_DESTRUCTION_INITIAL_STACKS_DEVA = 4;
export const IMMINENT_DESTRUCTION_INITIAL_STACKS_AUG = 6;
...
export const REFINED_ESSENCE_MULTIPLIER = 0.15;

export const MASS_DISINTEGRATE_MULTIPLIER_PER_MISSING_TARGET = 0.1;
export const MASS_ERUPTION_MULTIPLIER_PER_MISSING_TARGET =
  MASS_DISINTEGRATE_MULTIPLIER_PER_MISSING_TARGET;

export const MASS_DISINTEGRATE_TARGETS = 3;
export const CONCENTRATED_POWER_EXTRA_TARGETS = 1;

export const WINGLEADER_CDR_PER_HIT_MS = 1500;
export const WINGLEADER_CDR_PER_HIT_MS_DEVASTATION = 1000;

export const ASHES_IN_MOTION_CD_REDUCTION_SECONDS = 5;
export const ESSENCE_WELL_ESSENCE_CHANCE = 0.5;
