...
export default [
  ...
  change(date(2023, 1, 5), <>Updated cooldown timers for accuracy and added <SpellLink spell={TALENTS_WARRIOR.SHIELD_CHARGE_TALENT}/>, <SpellLink spell={TALENTS_WARRIOR.CHAMPIONS_SPEAR_TALENT}/>, and <SpellLink spell={TALENTS_WARRIOR.SHOCKWAVE_TALENT}/> (when <SpellLink spell={TALENTS_WARRIOR.SONIC_BOOM_TALENT}/> talented) to offensive cooldowns</>, Greedyhugs),
