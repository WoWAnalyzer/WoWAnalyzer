  ...
  return (
    <Checklist>
      <Rule
        ...
        description={
          <>
            ...
            <SpellLink spell={TALENTS.THUNDER_CLAP_TALENT} /> on cooldown to maximise
      ...
      <Rule
        ...
        description={
          <>
            ...
            <SpellLink spell={TALENTS.THUNDER_CLAP_TALENT} /> will have a reduced
      ...
      >
        ...
        {combatant.hasTalent(TALENTS.SHOCKWAVE_TALENT) && (
