...
/** Default duration is 4 seconds, Champion's Might increases by 2 seconds */
const SPEAR_DURATION = (4 + 2) * 1000;
const CRIT_DAMAGE_INCREASE = 0.25;

class ChampionsMight extends Analyzer {
  ...
  /**
   * The actual uptime of the Champion's Might buff.
   */
  ...
  private onDamage(event: DamageEvent) {
    if (
      this.selectedCombatant.getBuff(SPELLS.CHAMPIONS_MIGHT.id) &&
  ...
  private onFightEnd() {
    this._actualBuffUptime = this.selectedCombatant.getBuffUptime(SPELLS.CHAMPIONS_MIGHT.id);
  }
    ...
    return (
      <Statistic
        ...
        tooltip={
          <>
            <p>
              To gain the benefit of <SpellLink spell={TALENTS.CHAMPIONS_MIGHT_TALENT} />, you must
