...
class Recklessness extends Analyzer {
  ...
  onResourceChange(event: ResourceChangeEvent) {
    if (this.selectedCombatant.hasBuff(SPELLS.RECKLESSNESS.id)) {
      ...
      this._recklessnessRageGenerated += bonus.gain + bonus.waste;
    }
  }

  get recklessnessRageGenerated() {
    return this._recklessnessRageGenerated * RAGE_SCALE_FACTOR;
  }
      ...
      <Statistic
        ...
        tooltip={
          <>
            ...
            {formatPercentage(this.ratioReckRageGen, 0)}%) extra rage generated by Recklessness
            <br />
          </>
        }
      >
