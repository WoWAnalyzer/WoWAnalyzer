  ...
  get guideSubsection(): JSX.Element {
    const explanation = (
      <p>
        ...
        is one of our most efficient spells and should be cast on cooldown. <br></br>
        <br></br>
        Because its heal is triggered by damage, the active tank is a good target to cast this on.
      </p>
    );
