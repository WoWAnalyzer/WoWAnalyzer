...
export default [
  ...
  change(date(2024, 4, 20), <>Fix cooldown of <SpellLink spell={TALENTS_PRIEST.DESPERATE_PRAYER_TALENT} /> when using <SpellLink spell={TALENTS_PRIEST.ANGELS_MERCY_TALENT} />.</>, Arlie),
  change(
    date(2024, 4, 18),
    <>
