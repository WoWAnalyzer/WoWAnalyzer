...
export default [
  change(date(2026, 4, 1), <><SpellLink spell={TALENTS.PRAYER_OF_HEALING_TALENT} /> guide section update and <SpellLink spell={TALENTS.DIVINITY_TALENT} /> support.</>, Amiphite),
