...
class VoidTorrent extends Analyzer {
  _previousVoidTorrentCast: CastEvent | DamageEvent | null = null;
  damage = 0;
  ...
  //TODO: Make sure this still works now
  _voidTorrents: Record<string, VoidTorrentTime> = {};
  ...
  get timeWasted() {
    if (this.voidTorrents != undefined)
      return this.voidTorrents.reduce((total, c) => total + (c.wastedTime ?? 0), 0) / 1000;
  }

  get timeWastedPercentage() {
    return (this.timeWasted ?? 0) / this.totalChannelingTime;
  }
  ...
  onBuffRemoved(event: RemoveBuffEvent) {
    ...
    if (this._previousVoidTorrentCast != null) {
    ...
    return (
      ...
      >
        <BoringSpellValueText spell={TALENTS.VOID_TORRENT_TALENT}>
          <>
            <ItemDamageDone amount={this.damage} /> <div />
