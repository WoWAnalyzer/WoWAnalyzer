...
export default [
  change(date(2023, 5, 8), <>Fixed <SpellLink id={TALENTS.AUSPICIOUS_SPIRITS_TALENT}/>, <SpellLink id={TALENTS.SURGE_OF_INSANITY_TALENT}/>, <SpellLink id={TALENTS.DEATH_AND_MADNESS_TALENT}/>, <SpellLink id={TALENTS.SHADOWY_INSIGHT_TALENT}/>, </>,DoxAshe),
