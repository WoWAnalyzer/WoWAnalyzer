...
export default [
  change(date(2026, 4, 27), <>Add <SpellLink spell={TALENTS.INVOKED_NIGHTMARE_TALENT}/>, <SpellLink spell={TALENTS.TORMENTING_WHISPERS_TALENT}/>, <SpellLink spell={TALENTS.DESCENDING_DARKNESS_TALENT}/>, <SpellLink spell={TALENTS.SURGE_OF_INSANITY_TALENT}/> statistics</>,DoxAshe),
