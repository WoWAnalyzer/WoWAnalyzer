...
export const AUSPICIOUS_SPIRITS_DAMAGE_MULTIPLIER = 0.15;
...
export const MADDENING_TOUCH_DAMAGE_PER_RANK = 0.2;
export const INVOKED_NIGHTMARE_DAMAGE_PER_RANK = 1.5;
export const TORMENTING_WHISPERS_DAMAGE_PER_RANK = 0.15;
export const DESCENDING_DARKNESS_DAMAGE_PER_RANK = 3.0;
export const SURGE_OF_INSANITY_DAMAGE_PER_RANK = 0.15;
export const SURGE_OF_INSANITY_INSANITY_PER_RANK = 0.3;
export const HAUNTING_SHADOWS_DAMAGE_PER_RANK = 0.1;
export const MENTAL_DECAY_DAMAGE_PER_RANK = 0.25;
export const PHANTOM_MENACE_CRITDAMAGE_PER_RANK = 0.4;
export const PHANTOM_MENACE_CRITCHANCE_PER_RANK = 0.1;
