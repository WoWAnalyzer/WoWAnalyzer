...
export const ATONEMENT_DAMAGE_SOURCES = {
  ...
  [TALENTS.MIND_BLAST_TALENT.id]: true,
  ...
  [SPELLS.PENANCE_TWINSIGHT_DAMAGE.id]: true,
  [SPELLS.DARK_REPRIMAND_TWINSIGHT_DAMAGE.id]: true,
};
...
export const ATONEMENT_DAMAGE_IDS = [
  ...
  SPELLS.PENANCE_TWINSIGHT_DAMAGE.id,
  SPELLS.DARK_REPRIMAND_TWINSIGHT_DAMAGE.id,
];
...
export const EFFECTS_INCREASED_BY_BENEVOLENCE_DISCIPLINE = [
  ...
  SPELLS.PENANCE_TWINSIGHT_HEALING.id,
