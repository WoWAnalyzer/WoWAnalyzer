...
export const ATONEMENT_DAMAGE_SOURCES = {
  ...
  [TALENTS_PRIEST.PURGE_THE_WICKED_DISCIPLINE_TALENT.id]: true,
  [SPELLS.PURGE_THE_WICKED_BUFF.id]: true,
  [TALENTS_PRIEST.POWER_WORD_SOLACE_DISCIPLINE_TALENT.id]: true,
  [TALENTS_PRIEST.SCHISM_DISCIPLINE_TALENT.id]: true,
  ...
  [TALENTS_PRIEST.LIGHTS_WRATH_DISCIPLINE_TALENT.id]: true,
  [TALENTS_PRIEST.INESCAPABLE_TORMENT_DAMAGE_DISCIPLINE_TALENT.id]: true,
  [TALENTS_PRIEST.INESCAPABLE_TORMENT_DISCIPLINE_TALENT.id]: true,
  [TALENTS_PRIEST.INESCAPABLE_TORMENT_RIFT_DISCIPLINE_TALENT.id]: true,
};
...
export const ATONEMENT_SOURCE_FILTER: SpellFilter = [
  ...
  TALENTS_PRIEST.SCHISM_DISCIPLINE_TALENT,
