  ...
  return (
    <>
      ...
      <Section title="Rapture Ramp">
        ...
        <SpellLink id={TALENTS_PRIEST.ATONEMENT_TALENT.id} /> in its buff duration, followed by
        DPSing.
        <SubSection title="">
          ...
          <SpellLink id={TALENTS_PRIEST.POWER_WORD_RADIANCE_TALENT.id} />. You then fill the
          following GCDs with spells which do damage. Below are your rapture ramps with the most
