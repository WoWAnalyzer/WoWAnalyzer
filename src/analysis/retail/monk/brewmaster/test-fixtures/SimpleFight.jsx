...
export const staggerTicks = [
  {
    ...
    amount: 10,
    timestamp: 1000,
    ability: { guid: SPELLS.STAGGER_TAKEN.id },
  },
  {
    type: EventType.Damage,
    sourceID: enemy,
...
export const casts = [
  {
    ...
    targetid: thisPlayer,
    timestamp: 100,
    ability: { guid: SPELLS.GIFT_OF_THE_OX_1.id },
  },
  {
    type: EventType.Cast,
    sourceID: thisPlayer,
...
export const dpsCasts = [
  {
    ...
    targetid: enemy,
    timestamp: 3500,
    ability: { guid: SPELLS.BLACKOUT_KICK.id },
  },
  {
    type: EventType.Cast,
    sourceID: thisPlayer,
...
export const applybuff = [
  {
    ...
    targetid: thisPlayer,
    timestamp: 3500,
    ability: { guid: SPELLS.BLACKOUT_COMBO_BUFF.id },
  },
  {
    type: EventType.ApplyBuff,
    sourceID: thisPlayer,
...
export const staggerAbsorbed = [
  {
    ...
    amount: 300,
    timestamp: 500,
    ability: { guid: SPELLS.STAGGER.id },
    extraAbility: { guid: 1, type: 1 },
  },
  {
    type: EventType.Absorbed,
...
export const EarlyFinish = [
  ...
  .sort((a, b) => a.timestamp - b.timestamp)
  .filter((event) => event.timestamp <= 6000);
