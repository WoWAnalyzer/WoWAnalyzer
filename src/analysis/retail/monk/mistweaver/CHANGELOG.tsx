...
export default [
  ...
  change(date(2021, 4, 1), <>Updated Mana Costs for <SpellLink id={SPELLS.RENEWING_MIST.id} /> and <SpellLink id={TALENTS_MONK.VIVIFY_TALENT.id} /> to the correct values for 9.0.5.</>, Anomoly),
  ...
  change(date(2020, 10, 12), <>Updated <SpellLink id={TALENTS_MONK.ENVELOPING_MIST_TALENT.id} /> and <SpellLink id={SPELLS.SOOTHING_MIST.id} /> modules to use Event Listeners.</>, Anomoly),
