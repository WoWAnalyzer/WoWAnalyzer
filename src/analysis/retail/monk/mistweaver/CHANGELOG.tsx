...
export default [
  change(date(2022, 10, 13), <>Cleaned up Monk files</>, Trevor),
  change(date(2022, 10, 9), <>Added Secret Infusion haste buff and fixed Uplifted Spirits</>, Trevor),
  ...
  change(date(2021, 4, 1), <>Updated Mana Costs for <SpellLink id={TALENTS_MONK.RENEWING_MIST_TALENT.id} /> and <SpellLink id={SPELLS.VIVIFY.id} /> to the correct values for 9.0.5.</>, Anomoly),
  ...
  change(date(2020, 10, 12), <>Updated <SpellLink id={TALENTS_MONK.ENVELOPING_MIST_TALENT.id} /> and <SpellLink id={TALENTS_MONK.SOOTHING_MIST_TALENT.id} /> modules to use Event Listeners.</>, Anomoly),
  ...
  change(date(2020, 10, 6), <>Updated <SpellLink id={SPELLS.SPINNING_CRANE_KICK.id} /> and <SpellLink id={TALENTS_MONK.ESSENCE_FONT_TALENT.id} /> modules to use Event Listeners.</>, Anomoly),
  ...
  change(date(2020, 10, 6), <>Updated <SpellLink id={TALENTS_MONK.RENEWING_MIST_TALENT.id} /> to use Event Listeners.</>, Anomoly),
  ...
  change(date(2020, 9, 26), <>Added <SpellLink id={TALENTS_MONK.INVOKE_YULON_THE_JADE_SERPENT_TALENT.id} /> and <SpellLink id={TALENTS_MONK.INVOKE_CHI_JI_THE_RED_CRANE_TALENT.id} /> to the cooldown tracker.</>, Abelito75),
