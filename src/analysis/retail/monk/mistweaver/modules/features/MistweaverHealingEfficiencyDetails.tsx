        ...
        explanation={
          <>
            ...
            {this.selectedCombatant.hasTalent(TALENTS_MONK.ANCIENT_TEACHINGS_TALENT) && (
              <>
                <SpellLink spell={TALENTS_MONK.ANCIENT_TEACHINGS_TALENT} /> is given to spell that
                applied the buff, either <SpellLink spell={TALENTS_MONK.ESSENCE_FONT_TALENT} /> or{' '}
