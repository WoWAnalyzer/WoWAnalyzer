...
class HotTrackerMW extends HotTracker {
  ...
  _generateHotInfo(): HotInfo[] {
    ...
    const RAPID_DIFFUSION_DURATION = this.mistwrapActive
      ? RAPID_DIFFUSION *
        this.owner.selectedCombatant.getTalentRank(TALENTS_MONK.RAPID_DIFFUSION_TALENT.id)
      : 0;
    ...
    return [
      ...
      },
      {
        ...
        duration: this._calculateRemDuration,
        tickPeriod: 2000,
        maxDuration: RAPID_DIFFUSION_DURATION,
        bouncy: true,
        proc: true,
      },
      {
