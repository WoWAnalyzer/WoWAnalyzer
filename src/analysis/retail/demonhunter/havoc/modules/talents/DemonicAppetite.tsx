...
class DemonicAppetite extends Analyzer {
  ...
  constructor(options: Options) {
    ...
    this.active = this.selectedCombatant.hasTalent(
      TALENTS_DEMON_HUNTER.DEMONIC_APPETITE_HAVOC_TALENT.id,
    );
    if (!this.active) {
      return;
    }
    ...
    when(this.suggestionThresholds).addSuggestion((suggest, actual, recommended) =>
      suggest(
        <>
          ...
          <SpellLink id={TALENTS_DEMON_HUNTER.DEMONIC_APPETITE_HAVOC_TALENT.id} /> talent when close
          to Fury cap and cast abilities regularly to avoid accidently capping.
        </>,
      )
        .icon(TALENTS_DEMON_HUNTER.DEMONIC_APPETITE_HAVOC_TALENT.icon)
        .actual(
          t({
  ...
  statistic() {
    ...
    return (
      ...
      >
        <BoringSpellValueText spellId={TALENTS_DEMON_HUNTER.DEMONIC_APPETITE_HAVOC_TALENT.id}>
          <>
