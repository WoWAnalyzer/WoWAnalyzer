...
import { DEMONIC_APPETITE_HAVOC_TALENT } from 'common/TALENTS/demonhunter';
...
class DemonicAppetite extends Analyzer {
  ...
  constructor(options: Options) {
    super(options);
    this.active = this.selectedCombatant.hasTalent(DEMONIC_APPETITE_HAVOC_TALENT.id);
    if (!this.active) {
      return;
    }
    ...
    when(this.suggestionThresholds).addSuggestion((suggest, actual, recommended) =>
      suggest(
        <>
          ...
          <SpellLink id={DEMONIC_APPETITE_HAVOC_TALENT.id} /> talent when close to Fury cap and cast
          abilities regularly to avoid accidently capping.
        </>,
      )
        .icon(DEMONIC_APPETITE_HAVOC_TALENT.icon)
        .actual(
          t({
  ...
  statistic() {
    ...
    return (
      ...
      >
        <BoringSpellValueText spellId={DEMONIC_APPETITE_HAVOC_TALENT.id}>
          <>
