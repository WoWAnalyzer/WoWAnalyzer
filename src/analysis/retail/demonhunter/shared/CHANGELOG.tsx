...
export default [
  ...
  change(date(2022, 12, 29), <>Add statistic for damage added by <SpellLink spell={SPELLS.DEMON_SOUL_BUFF_NON_FODDER}/>, <SpellLink spell={SPELLS.DEMON_SOUL_BUFF_FODDER}/>, and <SpellLink spell={TALENTS.FODDER_TO_THE_FLAME_TALENT} />.</>, ToppleTheNun),
