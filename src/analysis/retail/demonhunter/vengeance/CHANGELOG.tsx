...
export default [
  ...
  change(date(2022, 4, 7), <>Added several conduits and updated <SpellLink id={TALENTS_DEMON_HUNTER.AGONIZING_FLAMES_VENGEANCE_TALENT.id} /> implementation.</>, xepheris),
