...
export default [
  ...
  change(date(2023, 2, 25), <>Fixed  consuming the last stack of <SpellLink spell={SPELLS.SOUL_FRAGMENT_STACK.id} /> not granting credit on casting <SpellLink spell={TALENTS.SPIRIT_BOMB_TALENT} />.</>, ToppleTheNun),
  change(date(2023, 1, 30), <>Fixed an issue where the graph for <SpellLink spell={SPELLS.SOUL_FRAGMENT_STACK.id} /> would show incorrect values for a given point in time.</>, Putro),
