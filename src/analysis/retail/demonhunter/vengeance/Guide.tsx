    ...
    <>
      ...
      <Section title="Cooldowns">
        <p>
          ...
          should aim to send the cooldown as soon as it becomes available (as long as it can do
          damage on target) if you won't need it for an upcoming mechanic. It is particularly
          important to use <SpellLink id={TALENTS_DEMON_HUNTER.FEL_DEVASTATION_TALENT.id} /> as
          often as possible.
          <br />
          <br />
