...
class BurningAlive extends Analyzer {
  ...
  constructor(options: Options) {
    super(options);
    this.active = this.selectedCombatant.hasTalent(TALENTS_DEMON_HUNTER.BURNING_ALIVE_TALENT.id);
  ...
  statistic() {
    return (
      ...
      >
        <BoringSpellValueText spellId={TALENTS_DEMON_HUNTER.BURNING_ALIVE_TALENT.id}>
