      ...
      <ExplanationRow>
        <Explanation>
          ...
          <p>
            ...
            along with the damage that you took. <strong>You do not need 100% uptime!</strong>{' '}
            However, damage taken without <SpellLink id={TALENTS_DEMON_HUNTER.FIERY_BRAND_TALENT} />{' '}
            active (shown in <Highlight color={red}>red</Highlight>) is dangerous!
          </p>
        </Explanation>
        <HitBasedOverview
          info={info}
