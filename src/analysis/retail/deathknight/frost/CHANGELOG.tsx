...
export default [
  change(date(2024, 9, 21), 'Updates for 11.0.2: General bug fixes and tweaks to ensure spec matches live - Boohbah', Khazak),
  ...
  change(date(2023, 4, 21), <>Added guide section for EMPOWER_RUNE_WEAPON_SHARED_TALENT</>, Khazak),
  ...
  change(date(2023, 3, 24), <>Improved RIME_TALENT and <SpellLink spell={talents.KILLING_MACHINE_TALENT} /> stats</>, Khazak),
