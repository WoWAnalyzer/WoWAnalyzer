...
import { Brandrewsss, HerzBlutRaffy } from 'CONTRIBUTORS';
import SpellLink from 'interface/SpellLink';
import SPELLS from 'common/SPELLS/deathknight';

const config: Config = {
  // The people that have contributed to this spec recently. People don't have to sign up to be long-time maintainers to be included in this list. If someone built a large part of the spec or contributed something recently to that spec, they can be added to the contributors list. If someone goes MIA, they may be removed after major changes or during a new expansion.
  contributors: [Brandrewsss, HerzBlutRaffy],
  ...
  description: (
    <>
      <p>
        Unholy Death Knights are disease specialists and undead masters, wielding rot and plague to
        devastating effect. In Midnight, the specialization focuses on summoning and commanding
        Lesser Ghouls, maintaining <SpellLink spell={SPELLS.VIRULENT_PLAGUE} /> and{' '}
        <SpellLink spell={SPELLS.DREAD_PLAGUE} />, and detonating your minions with{' '}
        <SpellLink spell={SPELLS.PUTREFY} />.
      </p>
      <p>
