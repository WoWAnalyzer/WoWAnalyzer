...
const CONFIG: Config = {
    ...
    description: (
      <>
        Hello fellow Netherlords! Thank you for taking the time to use this tool as a way to improve your play.
        While the goal of this tool is to improve your overall Affliction Warlock play, the tool is currently under
        active development and may provide suggestions that are incorrect or strange.
        <br /> <br />
