...
const TEMPORARY_PET_SUMMON_ABILITY_IDS = [
  ...
  TALENTS.SUMMON_VILEFIEND_TALENT.id,
  SPELLS.CHARHOUND_SUMMON.id,
  SPELLS.GLOOMHOUND_SUMMON.id,
  TALENTS.GRIMOIRE_IMP_LORD_TALENT.id,
  TALENTS.GRIMOIRE_FEL_RAVAGER_TALENT.id,
  ...
  SPELLS.MOTHER_OF_CHAOS_SUMMON.id,
  SPELLS.PIT_LORD_SUMMON.id,
  SPELLS.OVERLORD_SUMMON.id,
];
...
export const SUMMON_TO_SPELL_MAP = {
  ...
  [TALENTS.SUMMON_VILEFIEND_TALENT.id]: TALENTS.SUMMON_VILEFIEND_TALENT.id,
  [TALENTS.GRIMOIRE_IMP_LORD_TALENT.id]: TALENTS.GRIMOIRE_IMP_LORD_TALENT.id,
  [TALENTS.GRIMOIRE_FEL_RAVAGER_TALENT.id]: TALENTS.GRIMOIRE_FEL_RAVAGER_TALENT.id,
  [SPELLS.SUMMON_DEMONIC_TYRANT.id]: SPELLS.SUMMON_DEMONIC_TYRANT.id,
  [SPELLS.WILD_IMP_ID_SUMMON.id]: TALENTS.INNER_DEMONS_TALENT.id,
