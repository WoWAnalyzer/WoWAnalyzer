...
const CoreComboSection = ({ modules, info }: GuideProps<typeof CombatLogParser>) => (
  <Section title="Core Combo & Abilities">
    {modules.flameShock.guideSubsection()}
    {info.combatant.hasTalent(TALENTS_SHAMAN.ELECTRIFIED_SHOCKS_TALENT) &&
