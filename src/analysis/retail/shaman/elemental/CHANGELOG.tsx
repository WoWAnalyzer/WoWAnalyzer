...
export default [
  ...
  change(date(2022, 3, 4), <>Fixed issue with <SpellLink id={SPELLS.FIRE_ELEMENTAL.id} /> on the checklist when <SpellLink id={TALENTS.STORM_ELEMENTAL_TALENT.id} /> is selected.</>, emallson),
