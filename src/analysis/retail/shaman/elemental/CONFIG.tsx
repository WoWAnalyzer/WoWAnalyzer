import { HawkCorrigan, Periodic } from 'CONTRIBUTORS';
...
export default {
  ...
  contributors: [HawkCorrigan, Periodic],
  ...
  exampleReport:
    'http://localhost:3000/report/L1R2zVKY8ZDxCTNb/15-Mythic+Scalecommander+Sarkareth+-+Kill+(7:21)/Nerdshockz/standard',
