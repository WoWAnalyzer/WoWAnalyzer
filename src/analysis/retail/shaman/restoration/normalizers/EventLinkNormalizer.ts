...
import { EVENT_LINKS, CAST_BUFFER_MS, SPELL_DURATIONS } from '../constants';
...
const riptideEventLink: EventLink = {
  //Riptide linking | EX "HARDCAST"
...
const primalTideCoreEventLink: EventLink = {
  // Riptide CAST < > Duplicate LINK
...
const healingRainEventLink: EventLink = {
  //healing rain heal < > cast linking
...
const healingRainTargetCounter: EventLink = {
...
const overflowingShoresEventLink: EventLink = {
  //Overflowing Shores initial HEAL link to Healing Rain CAST
...
const downpourEventLink: EventLink = {
  // Downpour CAST < > HEAL LINK
...
const whirlingAirEventLink: EventLink = {
  ...
  referencedEventId: [SPELLS.HEALING_WAVE.id, TALENTS.CHAIN_HEAL_TALENT.id],
  referencedEventType: [EventType.Cast],
  backwardBufferMs: CAST_BUFFER_MS,
  forwardBufferMs: CAST_BUFFER_MS,
  anyTarget: true,
...
const whirlingEarthEventLink: EventLink = {
...
const whirlingWaterEventLink: EventLink = {
  // Whirling Water : Your next Healing Wave also heals an ally inside of your Healing Rain at 100% effectiveness.
...
const splitstreamEventLink: EventLink = {
...
const earthlivingEventLink: EventLink = {
...
const flowOfTheTidesEventLink: EventLink = {
  // Links riptide RemoveBuff event to chain heal CAST for "Flow of the Tides"
...
const chainHealEventLink: EventLink = {
  // Links the CAST event to the HEAL events
...
const livelyTotemsEventLink: EventLink = {
  // Links the SUMMON event of the totems with the next CAST event of chain heal
