...
export const PRIMORDIAL_BOND_MAX_HP_INCREASE = 0.15;
...
export const DEEP_HEALING_BONUS_SPELLPOINTS = {
  SPIRITUAL_AWAKENING: 3,
  ELEMENTAL_ATTUNEMENT: 2,
  SKYFURY: 2,
};

export const DAMAGE_REDUCTION = {
  SPIRIT_LINK_TOTEM_BASE: 0.1,
  SPIRIT_LINK_TOTEM_SPOUTING_SPIRITS: 0.15,
};
...
export const RESTORATION_COLORS = {
  ...
  DOWNPOUR: '#3b6760',
  UNUSED: '#CC3D20',
  SPIRIT_LINK_TOTEM_BASE: '#146585',
  SPOUTING_SPIRITS: '#203755',
  PRIMAL_TIDE_CORE: '#01B06A',
  EARTHSHIELD_BASE: '#f9a406',
  EARTHSHIELD_EARTHEN_HARMONY: '#f97306',
  EARTHSHIELD_EARTHWEAVER: '#f9e906',
  EARTHSHIELD_EARTHERN_COMMUNION: '#bcf906',
  EARTHSHIELD_THERAZANES_RESILIENCE: '#7ff906',
  EARTHSHIELD_REACTIVE_WARDING: '#2ef906',
  EARTHSHIELD_ELEMENTAL_ORBIT: '#06e5f9',
  WATER_SHIELD: '#55eeff',
  TIDECALLERS_GUARD: '#55eeff',
  EARTHLIVING_WEAPON: '#2ef906',
};
