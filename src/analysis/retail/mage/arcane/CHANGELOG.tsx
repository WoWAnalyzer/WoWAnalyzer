...
export default [
  ...
  change(date(2023, 3, 26), <>Renamed old <SpellLink spell={TALENTS.ARCANE_POWER_TALENT} /> into <SpellLink spell={TALENTS.ARCANE_SURGE_TALENT} /> in preparation for new analysis modules.</>, SyncSubaru),
