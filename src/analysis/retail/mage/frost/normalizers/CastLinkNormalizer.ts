...
const EVENT_LINKS: EventLink[] = [
  ...
  {
    reverseLinkRelation: SPELL_CAST,
    linkingEventId: SPELLS.BLIZZARD.id,
    linkingEventType: EventType.Cast,
    linkRelation: SPELL_DAMAGE,
    referencedEventId: SPELLS.BLIZZARD_DAMAGE.id,
    referencedEventType: EventType.Damage,
    forwardBufferMs: 8500,
    backwardBufferMs: CAST_BUFFER_MS,
  },
  {
    reverseLinkRelation: SPELL_CAST,
    linkingEventId: TALENTS.FROZEN_ORB_TALENT.id,
    linkingEventType: EventType.Cast,
    linkRelation: SPELL_DAMAGE,
    referencedEventId: SPELLS.FROZEN_ORB_DAMAGE.id,
    referencedEventType: EventType.Damage,
    anyTarget: true,
