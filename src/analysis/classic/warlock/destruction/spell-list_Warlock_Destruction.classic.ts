...
const SPELLS = {
  ...
  IMMOLATE_FIRE_AND_BRIMSTONE: {
    ...
    icon: 'ability_mage_worldinflames.jpg',
  },
  IMMOLATE: {
    id: 348,
    type: 'baseline',
  ...
  CURSE_OF_THE_ELEMENTS_FIRE_AND_BRIMSTONE: {
    id: 104225,
    grantedBy: 108683,
    type: 'temporary',
    overrides: 1490,
  ...
  RAIN_OF_FIRE_AFTERMATH_PASSIVE: {
    id: 104232,
    grantedBy: 109784,
    type: 'temporary',
    overrides: 42223,
  ...
  CONFLAGRATE_FIRE_AND_BRIMSTONE: {
    id: 108685,
    grantedBy: 108683,
    type: 'temporary',
    overrides: 17962,
  ...
  INCINERATE_FIRE_AND_BRIMSTONE: {
    ...
    icon: 'spell_fire_ragnaros_lavabolt.jpg',
  },
  INCINERATE: {
    id: 29722,
    type: 'baseline',
  ...
  MASTERY_EMBERSTORM_PASSIVE: {
    id: 77220,
    type: 'baseline',
    iconID: 135822,
    passive: true,
    name: 'Mastery: Emberstorm',
  ...
  BACKLASH_PASSIVE: {
    ...
    passive: true,
    name: 'Backlash',
    icon: 'spell_fire_playingwithfire.jpg',
  },
  BURNING_EMBERS_PASSIVE: {
    id: 108647,
    type: 'baseline',
    iconID: 460952,
    castableWhileCasting: true,
    passive: true,
    name: 'Burning Embers',
    icon: 'ability_warlock_burningembers.jpg',
  },
  FIRE_AND_BRIMSTONE: {
    id: 108683,
    type: 'baseline',
  ...
  CURSE_OF_ENFEEBLEMENT_FIRE_AND_BRIMSTONE: {
    id: 109468,
    grantedBy: 108683,
    type: 'temporary',
    overrides: 109466,
  ...
  PYROCLASM_PASSIVE: {
    ...
    passive: true,
    name: 'Pyroclasm',
    icon: 'inv_offhand_1h_firelandsraid_d_01.jpg',
  },
