...
function SoulReaperSection(): JSX.Element | null {
  ...
  return (
    <SubSection title="Soul Reaper (Execute)">
      <p>
        Cast <SpellLink spell={SPELLS.SOUL_REAPER_UNHOLY} /> every 6 seconds once the boss is below{' '}
      ...
      <CooldownBar
        spellId={SPELLS.SOUL_REAPER_UNHOLY.id}
  ...
  return (
    <Section title="Resource Use">
      <SubSection title="Runes &amp; Runic Power">
        <p>
          Runes are Death Knight's primary resource. Spending them builds Runic Power for{' '}
          <SpellLink spell={SPELLS.DEATH_COIL_DK} />. Avoid sitting capped on any rune type (2/2
          available) — capped runes are wasted regeneration. Gold bars in the cast timeline are{' '}
          <SpellLink spell={SPELLS.DEATH_COIL_DK} /> (RP spend).
        </p>
        {runeTracker.plot}
      </SubSection>
    </Section>
...
export default function UnholyDKGuide(): JSX.Element {
