...
const CONFIG: Config = {
  ...
  contributors: [Darkfrog, emallson],
  ...
  description: (
    <>
      ...
      Gargoyle cooldown tracking, and more. Actively maintained by Darkfrog — contributions welcome!
  ...
  exampleReport:
    '/report/9B8xdCHVwPqQ7DYL/33-Heroic+Iron+Juggernaut+-+Kill+(4:56)/10-Ketchupchips/standard',
