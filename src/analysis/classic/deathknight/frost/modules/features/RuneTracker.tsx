...
/**
 * Frost DK rune tracker.
 * Blood of the North (passive): Blood runes are permanently Death runes.
 */
class FrostRuneTracker extends MoPRuneTracker {
...
export default FrostRuneTracker;
