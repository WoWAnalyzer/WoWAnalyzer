...
const config: Config = {
  ...
  exampleReport: '/report/vWg3QJn1DkBPbGT4/5-Heroic+Lord+Marrowgar+-+Kill+(2:41)/7-Philwestsid',
  // Add spells to display separately on the timeline
  timeline: {
    separateCastBars: [[]],
  },
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_PALADIN_PROTECTION,
  ...
  parser: () =>
    import('./CombatLogParser' /* webpackChunkName: "ClassicProtectionPaladin" */).then(
