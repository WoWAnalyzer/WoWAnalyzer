    ...
    when(this.downtimeSuggestionThresholds).addSuggestion((suggest, actual, recommended) =>
      suggest(
        <span>
          ...
          <SpellLink spell={SPELLS.HEROIC_THROW} /> into your rotation if no other GCD is available or
          would be delayed by it. Also use it should you ever need to leave melee range and have no
