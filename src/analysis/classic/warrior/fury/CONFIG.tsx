import { Xinito } from 'CONTRIBUTORS';
...
const config: Config = {
  ...
  exampleReport: '/report/4ynbN7ZwK8fpvxhR/50-Heroic+Iron+Qon+-+Kill+(5:54)/47-Skullbonka',
  // Add spells to display separately on the timeline
  timeline: {
    separateCastBars: [[]],
  },
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_WARRIOR_FURY,
  ...
  parser: () =>
    import('./CombatLogParser' /* webpackChunkName: "ClassicFuryWarrior" */).then(
