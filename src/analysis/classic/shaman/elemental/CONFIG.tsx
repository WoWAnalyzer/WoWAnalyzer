...
const CONFIG: Config = {
  ...
  exampleReport: '/report/qDmYhQr67fRd48nK/7-Heroic+Ascendant+Council+-+Kill+(3:50)/21-Shamlaundoh',

  // USE CAUTION when changing anything below this line.
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_SHAMAN_ELEMENTAL,
  // The contents of your changelog.
  changelog: CHANGELOG,
  // The CombatLogParser class for your spec.
  parser: () =>
    import('./CombatLogParser' /* webpackChunkName: "ClassicElementalShaman" */).then(
