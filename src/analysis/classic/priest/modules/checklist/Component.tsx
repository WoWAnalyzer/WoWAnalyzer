    ...
    <Checklist>
        ...
        description={
          <>
            ...
            {combatant.owner.build !== Build.SHADOW && (
              <>
                <SpellLink id={SPELLS.PRAYER_OF_MENDING} /> should be used on cooldown any time that
                you don't have 5 stacks up on a tank.
              </>
            )}
          </>
        }
      >
        ...
        {combatant.owner.build === Build.HOLY && (
          <AbilityRequirement spell={SPELLS.CIRCLE_OF_HEALING} />
        )}
      </Rule>
      {combatant.owner.build === Build.SHADOW && (
        <Rule
          ...
          description={
            <>
              ...
              <SpellLink id={SPELLS.SHADOW_WORD_PAIN} /> after applying 5 stacks of{' '}
              <SpellLink id={SPELLS.SHADOW_WEAVING_TALENT} />
            </>
          }
        >
      ...
      <Rule
        ...
        description={
          <>
            Wrath doesn't have as many cooldowns as retails, but they still play an important part
            of optimizing your play. <SpellLink id={SPELLS.SHADOW_FIEND} /> should be used any time
            you are below 70% mana, and If you spec into <SpellLink id={SPELLS.PAIN_SUPPRESSION} />,{' '}
