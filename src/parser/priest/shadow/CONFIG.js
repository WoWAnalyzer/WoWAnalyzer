...
export default {
  ...
  exampleReport: '/report/HTfJYK8RgG17drjq/9-Heroic+Jadefire+Masters+-+Kill+(6:08)/6-Gabethedark',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "ShadowPriest" */).then(exports => exports.default)),
