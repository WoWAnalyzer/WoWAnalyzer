...
export default {
  ...
  exampleReport: '/report/DPwyKpWBZ6F947mx/2-Normal+Mekkatorque+-+Kill+(7:19)/28-Heàdhunterz',
  ...
  parser: () => import('./CombatLogParser' /* webpackChunkName: "HolyPriest" */).then(exports => exports.default),
