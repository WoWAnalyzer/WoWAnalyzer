  ...
  statistic() {
    ...
    return (
      <StatisticBox
        ...
        label={(
          <Tooltip content={`The amount of shield absorb remaining on Power Word: Shield instances that have expired. There was a total of ${formatNumber(wasted)} unused Power Word: Shield absorb from ${count} shields with absorb remaining (a total of ${totalCount} shields were applied).`}>
            Unused PW:S absorb
          </Tooltip>
          )}
      />
