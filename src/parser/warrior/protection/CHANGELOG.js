...
export default [  
  change(date(2019, 8, 26),<>Updated config for warrior... No more stone age! </>,Abelito75),
  ...
  change(date(2019, 8, 24),<>Added new <SpellLink id={SPELLS.SHIELD_BLOCK.id} /> logic to be able to determin if a shield block is good or bad from either a defensive or offensive pov.</>,Abelito75),
  change(date(2019, 8, 23),<>Updated Threshholds for <SpellLink id={SPELLS.HEAVY_REPERCUSSIONS_TALENT.id} /> to be humanly possible. </>,Abelito75),
