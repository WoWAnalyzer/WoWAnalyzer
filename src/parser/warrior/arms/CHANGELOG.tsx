...
export default [
  change(
    date(2020, 12, 26),
    <>
      Added <SpellLink id={SPELLS.SPEAR_OF_BASTION.id} />,{' '}
      <SpellLink id={SPELLS.CONQUERORS_BANNER.id} />, and{' '}
      <SpellLink id={SPELLS.ANCIENT_AFTERSHOCK.id} /> to cooldowns section.
    </>,
    Carrottopp,
  ),
