...
const MID_TIER_FOOD_IDS = [
  SPELLS.WELL_FED_EVERYTHING_STEW.id,
  SPELLS.HEARTY_WELL_FED_EVERYTHING_STEW.id,
...
const HIGHER_FOOD_IDS = [
  SPELLS.WELL_FED_HIGHEST_SECONDARY.id,
  SPELLS.HEARTY_WELL_FED_HIGHEST_SECONDARY.id,
