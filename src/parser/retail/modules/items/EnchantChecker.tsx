...
const MIN_ENCHANT_IDS = [
  ...
  // #region Boots
  ITEMS.BOOT_FARSTRIDERS_HUNT_R1.effectId,
  ITEMS.BOOT_LYNXS_DEXTERITY_R1.effectId,
  ITEMS.BOOT_SHALADRASSILS_ROOTS_R1.effectId,
  // #endregion

  // #region Ring
  ITEMS.RINGS_AMANI_MASTERY_R1.effectId,
  ITEMS.RINGS_AMANI_MASTERY_R2.effectId,
  ITEMS.RINGS_EYES_OF_THE_EAGLE_R1.effectId,
  ITEMS.RINGS_NATURES_FURY_R1.effectId,
  ITEMS.RINGS_NATURES_WRATH_R1.effectId,
  ITEMS.RINGS_NATURES_WRATH_R2.effectId,
  ITEMS.RINGS_SILVERMOONS_ALACRITY_R1.effectId,
  ITEMS.RINGS_SILVERMOONS_TENACITY_R1.effectId,
  ITEMS.RINGS_THALASSIAN_HASTE_R1.effectId,
  ITEMS.RINGS_THALASSIAN_HASTE_R2.effectId,
  ITEMS.RINGS_THALASSIAN_VERSATILITY_R1.effectId,
  ITEMS.RINGS_THALASSIAN_VERSATILITY_R2.effectId,
  ITEMS.RINGS_ZULJINS_MASTERY_R1.effectId,
  // #endregion
  ...
  // #region Shoulder
  ITEMS.SHOULDER_AKILZONS_SWIFTNESS_R1.effectId,
  ITEMS.SHOULDER_AMIRDRASSILS_GRACE_R1.effectId,
  ITEMS.SHOULDER_FLIGHT_OF_THE_EAGLE_R1.effectId,
  ITEMS.SHOULDER_FLIGHT_OF_THE_EAGLE_R2.effectId,
  ITEMS.SHOULDER_NATURES_GRACE_R1.effectId,
  ITEMS.SHOULDER_NATURES_GRACE_R2.effectId,
  ITEMS.SHOULDER_SILVERMOONS_MENDING_R1.effectId,
  ITEMS.SHOULDER_THALASSIAN_RECOVERY_R1.effectId,
  ITEMS.SHOULDER_THALASSIAN_RECOVERY_R2.effectId,
  // #endregion
...
const MAX_ENCHANT_IDS = [
  ...
  // #region Boots
  ITEMS.BOOT_FARSTRIDERS_HUNT_R2.effectId,
  ITEMS.BOOT_LYNXS_DEXTERITY_R2.effectId,
  ITEMS.BOOT_SHALADRASSILS_ROOTS_R2.effectId,
  // #endregion

  // #region Ring
  ITEMS.RINGS_EYES_OF_THE_EAGLE_R2.effectId,
  ITEMS.RINGS_SILVERMOONS_ALACRITY_R2.effectId,
  ITEMS.RINGS_SILVERMOONS_TENACITY_R2.effectId,
  ITEMS.RINGS_ZULJINS_MASTERY_R2.effectId,
  ITEMS.RINGS_NATURES_FURY_R2.effectId,
  // #endregion
  ...
  // #region Shoulder
  ITEMS.SHOULDER_AKILZONS_SWIFTNESS_R2.effectId,
  ITEMS.SHOULDER_AMIRDRASSILS_GRACE_R2.effectId,
  ITEMS.SHOULDER_SILVERMOONS_MENDING_R2.effectId,
  // #endregion
