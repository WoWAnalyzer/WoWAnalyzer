...
const MIN_ENCHANT_IDS = [
  ...
  // #region Weapon
  ITEMS.FARSTRIDERS_HAWKEYE_R1.effectId,
  ITEMS.SMUGGLERS_LYNXEYE_R1.effectId,
  ...
  ITEMS.WEAPON_RITE_OF_THE_HASHEY_R1.effectId,
...
const MAX_ENCHANT_IDS = [
  ...
  // #region Weapon
  ITEMS.FARSTRIDERS_HAWKEYE_R2.effectId,
  ITEMS.SMUGGLERS_LYNXEYE_R2.effectId,
  ...
  ITEMS.WEAPON_RITE_OF_THE_HASHEY_R2.effectId,
