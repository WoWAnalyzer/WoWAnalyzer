...
import { Chizu, Dambroda, Putro, Sharrq } from 'CONTRIBUTORS';
...
export default [
  ...
  change(date(2018, 12, 10), <>Updated for patch 8.1 - <SpellLink id={SPELLS.UNSTABLE_AFFLICTION.id} /> nerf.</>, [Chizu]),
  change(date(2018, 11, 15), <>Added <SpellLink id={SPELLS.UNSTABLE_AFFLICTION.id} /> to timeline as well</>, [Chizu]),
  ...
  change(date(2018, 9, 20), <>Added <SpellLink id={SPELLS.UNSTABLE_AFFLICTION.id} icon /> uptime module and added it into Checklist.</>, [Chizu]),
