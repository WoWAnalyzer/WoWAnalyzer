  ...
  subStatistic() {
    ...
    return (
      <StatisticListBoxItem
        ...
        valueTooltip={(
          <>
            You gained {shardsGained} Shards from this talent, which is <strong>{formatPercentage(shardsGained / max)}%</strong> of Shards you were most likely to get in this fight (${max} Shards).<br />
