...
describe('core/Modules/Normalizers/MissingDotApplyDebuffPrePull', () => {
  ...
  it('only works on selected player', () => {
    ...
    const events: AnyEvent[] = [
      { timestamp: 50, type: EventType.ApplyDebuff, sourceID:2, sourceIsFriendly:true, targetID:3, targetIsFriendly:false, ability: { name: SPELLS.AGONY.name, guid: SPELLS.AGONY.id, type:32, abilityIcon: SPELLS.AGONY.icon }, targetInstance: 0},
      { timestamp: 1000, type: EventType.Damage, sourceID:2, sourceIsFriendly:true, targetID:3, targetIsFriendly:false, ability: { name: SPELLS.AGONY.name, guid: SPELLS.AGONY.id, type:32, abilityIcon: SPELLS.AGONY.icon }, hitType:1, amount:486, unmitigatedAmount:486, tick:true, resourceActor:2, spellPower: 0, targetInstance: 0},
      { timestamp: 1000, type: EventType.Damage, sourceID:1, sourceIsFriendly:true, targetID:3, targetIsFriendly:false, ability: { name: SPELLS.AGONY.name, guid: SPELLS.AGONY.id, type:32, abilityIcon: SPELLS.AGONY.icon }, hitType:1, amount:486, unmitigatedAmount:486, tick:true, resourceActor:2, spellPower: 0, targetInstance: 0},
    ];
