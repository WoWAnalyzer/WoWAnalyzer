...
class StatTracker extends Analyzer {
  ...
  static DEFAULT_BUFFS = {
    ...
    [SPELLS.FAMINE_EVALUATOR_AND_SNACK_TABLE_FEFAST_INT.id]: { intellect: 131 },
    [SPELLS.FAMINE_EVALUATOR_AND_SNACK_TABLE_FEFAST_STR.id]: { strength: 131 },
    [SPELLS.FAMINE_EVALUATOR_AND_SNACK_TABLE_FEFAST_AGI.id]: { agility: 131 },
    [SPELLS.FAMINE_EVALUATOR_AND_SNACK_TABLE_FEFAST_STA.id]: { stamina: 198 },
