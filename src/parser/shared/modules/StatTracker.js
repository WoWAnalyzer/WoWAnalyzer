...
import { STAT_TRACKER as TWISTED_CLAWS_STATS } from 'parser/druid/guardian/modules/azeritetraits/TwistedClaws';
...
class StatTracker extends Analyzer {
  ...
  static STAT_BUFFS = {
    ...
    // endregion
    // region Druid
    [SPELLS.TWISTED_CLAWS_BUFF.id]: TWISTED_CLAWS_STATS,
    // endregion
    // region Enchants
