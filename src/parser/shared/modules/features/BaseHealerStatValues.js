                    ...
                    <tr key={'QELive'}>
                      <td>
                        ...
                        <Tooltip content={'Opens in a new tab. Leverage the QE Live Tool to directly compare gear, azerite traits, and trinkets based on your stat values'}>
                          <a
                            href={`https://www.questionablyepic.com/live?name=${this.selectedCombatant.name}&realm=${this.selectedCombatant.characterProfile.realm}&region=${this.selectedCombatant.characterProfile.region}${_url}`}
                            target="_blank"
