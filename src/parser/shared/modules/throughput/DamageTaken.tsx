...
class DamageTaken extends Analyzer {
  ...
  _addDamage(
    ...
    if (this._byAbility[spellId]) {
      ...
      this._byAbility[spellId] = new DamageValue().add(amount, absorbed, blocked, overkill);
    }
    ...
    if (this._byMagicSchool[magicSchool]) {
      ...
      this._byMagicSchool[magicSchool] = new DamageValue().add(amount, absorbed, blocked, overkill);
    }
  ...
  get tooltip() {
    const physical = this._byMagicSchool[MAGIC_SCHOOLS.ids.PHYSICAL]
      ? this._byMagicSchool[MAGIC_SCHOOLS.ids.PHYSICAL].effective
      : 0;
