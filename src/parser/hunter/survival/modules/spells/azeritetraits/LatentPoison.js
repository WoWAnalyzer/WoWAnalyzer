  ...
  statistic() {
    return (
      <TraitStatisticBox
        ...
        tooltip={(<>
          {this.utilised} debuffs consumed / {this.maxPossible} possible. {this.wasted > 0 && <><br /> You cast {this.spellKnown} {this.wasted} times while you already had {MAX_STACKS} stacks on the target.</>}
        </>)}
      />
    );
  }
