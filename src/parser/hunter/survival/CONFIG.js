...
export default {
  ...
  exampleReport: '/report/wptPT3mfWavbj9KY/33-Heroic+Conclave+of+the+Chosen+-+Kill+(6:22)/2-Ptr',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "SurvivalHunter" */).then(exports => exports.default)),
