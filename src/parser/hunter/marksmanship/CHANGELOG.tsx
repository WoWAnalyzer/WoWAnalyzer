...
export default [
  change(date(2020, 6, 10), <> Add a graph to show how (un)lucky you were with <SpellLink id={SPELLS.LOCK_AND_LOAD_TALENT.id} /> and <SpellLink id={SPELLS.VOLLEY_TALENT.id} /> procs. </>, Putro),
