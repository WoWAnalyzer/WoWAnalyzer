...
export default {
  ...
  description: (
    <>
      Hello and welcome to the Marksmanship Hunter analyzer! We hope that the suggestions and statistics will be helpful in improving your overall performance. Try and focus on improving only a few things at a time, until those become ingrained in your muscle memory so as to not be concentrating on many different things.<br /><br />
  ...
  exampleReport: '/report/DPwyKpWBZ6F947mx/2-Normal+Mekkatorque+-+Kill+(7:19)/23-Pirouette',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "MarksmanshipHunter" */).then(exports => exports.default)),
