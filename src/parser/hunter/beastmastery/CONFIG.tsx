...
export default {
  ...
  // someone built a large part of the spec or contributed something recently
  // to that spec, they can be added to the contributors list. If someone goes
  // MIA, they may be removed after major changes or during a new expansion.
  contributors: [Putro],
  ...
  // complete it is, and perhaps show links to places users can learn more. If
  // this spec's analysis does not show a complete picture please mention this
  ...
  exampleReport: '/report/DPwyKpWBZ6F947mx/2-Normal+Mekkatorque+-+Kill+(7:19)/6-Leewee',

  // Don't change anything below this line;
  // The current spec identifier. This is the only place (in code) that
