...
class AspectOfTheWild extends Analyzer {
  ...
  constructor(options: Options) {
    ...
    this.selectedCombatant.hasLegendaryByBonusID(NESINGWARYS_TRAPPING_APPARATUS_EFFECT.bonusID ? NESINGWARYS_TRAPPING_APPARATUS_EFFECT.bonusID : 0 ) && this.addEventListener(Events.energize.by(SELECTED_PLAYER).spell(SPELLS.ASPECT_OF_THE_WILD), this.checkNesingwaryFocusGain);
  }
