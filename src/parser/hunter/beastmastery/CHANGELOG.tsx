...
export default [
  change(date(2020, 1, 24), <> Updated the <SpellLink id={SPELLS.BARBED_SHOT.id} /> module to allow for up to 8 simultaenous buffs running, which reflects behaviour in-game. </>, Putro),
