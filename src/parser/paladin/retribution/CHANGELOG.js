...
import { Juko8, Skeletor, Abelito75, Zeboot, Hordehobbs } from 'CONTRIBUTORS';
...
export default [
  ...
  change(date(2019, 3, 7), <> Added module to display Indomitable Justice benefit.</>, Skeletor),
  ...
  change(date(2018, 9, 20), <> Added Relentless Inquisitor.</>, Juko8),
