...
import { Zerotorescue, HolySchmidt, Abelito75, blazyb, Taleria, Torothin, Putro, Zeboot } from 'CONTRIBUTORS';
...
export default [
  ...
  change(date(2020, 1, 15), <>Removed <SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> 8.3 nerf prediction statistic.</>, [Zerotorescue]),
  change(date(2020, 1, 5), <>Added <SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> 8.3 nerf prediction statistic to see how the nerf will affect you.</>, [Zerotorescue]),
  change(date(2020, 1, 1), <>Added <SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> build suggestions for early overwriting of active glimmers and added support for 8.3 buff cap of 8.</>, [HolySchmidt]),
  ...
  change(date(2019, 12, 1), <><SpellLink id={SPELLS.CRUSADERS_MIGHT_TALENT.id} /> cooldown reduction will correctly adjust for <SpellLink id={SPELLS.SANCTIFIED_WRATH_TALENT.id} />, added <SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> build support and fixed spelling errors.</>, [HolySchmidt]),
  change(date(2019, 12, 1), <><SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> build has been added for Holy Paladin, will now link to a guild on the build and not suggest that all mana must be used during a fight.</>, [HolySchmidt]),
  ...
  change(date(2019, 6, 13), <><SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> statistic added showing healing, damage, beacon healing, <SpellLink id={SPELLS.HOLY_SHOCK_CAST.id} />s/min and refresh utilization.</>, [HolySchmidt]),
  ...
  change(date(2019, 3, 21), <> Grace of the justicar statistic added showing total healing, players hit per cast and healing transfered to beacons.</>, [HolySchmidt]),
  ...
  change(date(2019, 2, 24), <><SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> has been marked as scaling with Mastery and Haste and should now affect the stat values.</>, [Zerotorescue]),
  change(date(2019, 1, 30), <><SpellLink id={SPELLS.GLIMMER_OF_LIGHT_TALENT.id} /> has been added to the list of spells that beacon transfer (50% efficiency).</>, [Zerotorescue]),
