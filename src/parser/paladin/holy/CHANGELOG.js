...
export default [
  change(date(2019, 11, 25), <><SpellLink id={SPELLS.LIGHTS_DECREE.id} /> fixed duration calculation along with <SpellLink id={SPELLS.HOLY_SHOCK_CAST.id} /> usage, damage, healing, and critical strike contributions.</>, [HolySchmidt]),
