...
class FillerFlashOfLight extends Analyzer {
  ...
  on_byPlayer_cast(event) {
    ...
    if (this._isCurrentCastInefficient) {
      ...
      event.meta.inefficientCastReason = (
        <Trans id="paladin.holy.fillerFlashOfLight.inefficientCast">
  ...
  suggestions(when) {
    when(this.suggestionThresholds).addSuggestion((suggest, actual) => {
      return suggest(
        <Trans id="paladin.holy.fillerFlashOfLight.suggestion">
          ...
          <TooltipElement
            content={
              <Trans id="paladin.holy.fillerFlashOfLight.suggestion.availableTooltip">
          ...
          <TooltipElement
            content={
              <Trans id="paladin.holy.fillerFlashOfLight.suggestion.exceptionsTooltip">
        ...
        .actual(
          <Trans id="paladin.holy.fillerFlashOfLight.suggestion.actual">
            {actual} casts while Holy Shock was available
          </Trans>,
        )
        .recommended(
          <Trans id="paladin.holy.fillterFlashOfLight.suggestion.recommended">
