...
export default [
  change(date(2020, 10, 23), <>Added statistics, suggestions and checklist entries for <SpellLink id={SPELLS.WATER_SHIELD.id} /> and <SpellLink id={SPELLS.EARTH_SHIELD.id} />.</>, niseko),
  change(date(2020, 10, 23), <>Added statistics, suggestions and checklist entries for <SpellLink id={SPELLS.SURGE_OF_EARTH_TALENT.id} />.</>, niseko),
