...
const RestoShamanChecklist = ({ combatant, castEfficiency, thresholds }: any) => {
  ...
  return (
    <Checklist>
      ...
      >
          <Requirement
            name={<Trans id="shaman.restoration.checklist.appliedPrepull"><SpellLink id={SPELLS.EARTH_SHIELD_HEAL.id} /> applied prepull</Trans>}
            thresholds={thresholds.earthShieldPrepull}
          />
          <Requirement
            name={<Trans id="shaman.restoration.checklist.uptime"><SpellLink id={SPELLS.EARTH_SHIELD_HEAL.id} /> Uptime</Trans>}
