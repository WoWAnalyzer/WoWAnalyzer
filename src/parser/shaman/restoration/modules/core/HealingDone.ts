...
class HealingDone extends CoreHealingDone {
  constructor(options: Options) {
    ...
    this.addEventListener(Events.damage.by(SELECTED_PLAYER_PET).spell(SPELLS.SPIRIT_LINK_TOTEM_REDISTRIBUTE), this._onSLTDamage);
  }

  _onSLTDamage(event: DamageEvent) {
