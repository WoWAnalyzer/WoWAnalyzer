...
export default [
  change(date(2019, 12, 10), <>Added a list of <SpellLink id={SPELLS.CHAIN_HEAL.id} /> casts that only hit one target to the <SpellLink id={SPELLS.CHAIN_HEAL.id} /> statistic, if that happened.</>, niseko),
