...
export default {
  ...
  exampleReport: '/report/3jzL7DNhb8arByxR/19-Heroic+G\'huun+-+Wipe+9+(10:38)/7-Kamnie',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "RestorationShaman" */).then(exports => exports.default)),
