...
export default [
  change(date(2020, 10, 31), <>Adding a module Static </>, HawkCorrigan),
  ...
  change(date(2019, 11, 29), <>Add a statistic counting the amount of maelstrom not wasted due to Call The Thunder.</>, [Draenal]),
  ...
  change(date(2019, 10, 26), <>Add a checklist item for Totem Mastery uptime.</>, [Draenal]),
