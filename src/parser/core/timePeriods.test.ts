...
export function ctp(start: number, end: number) {
  return { start, end };
}
export function otp(start?: number, end?: number) {
  return { start, end };
}
...
describe('union', () => {
  it('handles simple non-overlapping', () => {
    expect(union([ctp(10, 20)], ctp(0, 100))).toEqual([ctp(10, 20)]);
    expect(union([ctp(0, 10), ctp(30, 40), ctp(70, 90)], ctp(0, 100))).toEqual([
      ctp(0, 10),
      ctp(30, 40),
      ctp(70, 90),
    ]);
  ...
  it('handles overlapping', () => {
    expect(union([ctp(10, 30), ctp(20, 40)], ctp(0, 100))).toEqual([ctp(10, 40)]);
    expect(union([ctp(10, 30), ctp(20, 40), ctp(35, 70), ctp(90, 110)], ctp(0, 100))).toEqual([
      ctp(10, 70),
      ctp(90, 100),
    ]);
    expect(union([ctp(10, 70), ctp(20, 40), ctp(35, 60), ctp(90, 110)], ctp(0, 100))).toEqual([
      ctp(10, 70),
      ctp(90, 100),
    ]);
  });
  it('handles adjacent merging', () => {
    expect(union([ctp(10, 30), ctp(30, 40)], ctp(0, 100))).toEqual([ctp(10, 40)]);
  });
  it('handles open time periods', () => {
    expect(union([otp(undefined, 30), ctp(20, 40), otp(60, undefined)], ctp(0, 100))).toEqual([
      ctp(0, 40),
      ctp(60, 100),
    ]);
  });
  it('handles out of order time periods', () => {
    expect(union([ctp(70, 90), ctp(0, 10), ctp(30, 40)], ctp(0, 100))).toEqual([
      ctp(0, 10),
      ctp(30, 40),
      ctp(70, 90),
    ]);
    expect(union([ctp(70, 90), ctp(15, 30), ctp(5, 20)], ctp(0, 100))).toEqual([
      ctp(5, 30),
      ctp(70, 90),
    ]);
  });
