...
const spells: number[] = [
  ...
  SPELLS.SOUL_FRAGMENT_2.id, // new soul fragment id in Midnight - devourer only?
  ...
  SPELLS.FELBLADE_CHARGE.id, // The spell that charges the player to the target
