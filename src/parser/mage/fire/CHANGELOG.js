...
export default [
  change(date(2019, 10, 9), <>Added analysis for using <SpellLink id={SPELLS.METEOR_TALENT.id} /> during <SpellLink id={SPELLS.COMBUSTION.id} />. Also adjusted Meteor Efficiency target to account for holding it for Combustion.</>,[Sharrq]),
