...
export default [
  ...
  change(date(2019, 9, 3), <>Fixed bug in Memory of Lucid Dreams.</>, [Sharrq]),
  change(date(2019, 8, 27), <>Update Blaster Master explanation graphic to new version.</>, [Sharrq]),
  change(date(2019, 8, 21), <>Add support for Fire Blast cooldown reduction from Memory of Lucid Dreams.</>, [Sharrq]),
  ...
  change(date(2019, 8, 19), <>Added support for Hyperthread Wristwraps.</>, [Sharrq]),
  ...
  change(date(2018, 11, 28), <>Updated <SpellLink id={SPELLS.COMBUSTION.id} /> module to support Blaster Master.</>, [Sharrq]),
  ...
  change(date(2018, 11, 15), <>Added support for Blaster Master.</>, [Sharrq]),
