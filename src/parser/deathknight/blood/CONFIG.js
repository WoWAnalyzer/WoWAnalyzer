...
export default {
  ...
  exampleReport: '/report/wptPT3mfWavbj9KY/33-Heroic+Conclave+of+the+Chosen+-+Kill+(6:22)/64-Jakedk',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "BloodDeathKnight" */).then(exports => exports.default)),
