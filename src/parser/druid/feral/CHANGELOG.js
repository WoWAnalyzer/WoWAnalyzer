...
import { Abelito75, Zeboot, LeoZhekov, Tora, Xcessiv } from 'CONTRIBUTORS';
...
export default [
  ...
  change(
    date(2020, 11, 6),
    <>
      Replaced the deprecated StatisticBoxes with the new Statistic and reworked SavageRoar module.
    </>,
    LeoZhekov,
  ),
