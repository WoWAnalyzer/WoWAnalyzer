        ...
        <Rule
          ...
          description={(
            <>
              ...
              Against <TooltipElement content="Above 10 to 15 enemies, depending on your haste and mastery">very high</TooltipElement> numbers of enemies it becomes more effective to use your energy on <SpellLink id={SPELLS.SWIPE_CAT.id} /> rather than using <SpellLink id={SPELLS.RIP.id} /> or <SpellLink id={SPELLS.FEROCIOUS_BITE.id} />. You should still maintain <SpellLink id={SPELLS.SAVAGE_ROAR_TALENT.id} /> if you have the talent selected.
            </>
          )}
        >
