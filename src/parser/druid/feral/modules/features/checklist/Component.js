      ...
      <Checklist>
        ...
        */}
        <Rule
          ...
          description={(
            <>
              <Tooltip content="Tiger's Fury affects all DoTs, Bloodtalons affects all except Moonfire.">Certain buffs</Tooltip> will increase the damage of your DoTs for their full duration, even after the buff wears off. Making the most of this mechanic can be the difference between good and great results.<br />
              As a general rule it's beneficial to refresh a DoT early if you would increase the snapshot. It's better to refresh with a weaker version of the DoT during the <Tooltip content="The last 30% of the DoT's duration. If you refresh during this time you don't lose any duration in the process.">pandemic window</Tooltip> than to let it wear off. The exception is <SpellLink id={SPELLS.RAKE.id} /> empowered by <Tooltip content="The effect is also provided by Incarnation: King of the Jungle, and Shadowmeld for Night Elves">Prowl</Tooltip> which is so much stronger that you should wait until the DoT wears off when replacing it with an unbuffed version.
            </>
          )}
        >
          {combatant.hasTalent(SPELLS.LUNAR_INSPIRATION_TALENT.id) && (
