...
export default {
  ...
  exampleReport: '/report/DPwyKpWBZ6F947mx/2-Normal+Mekkatorque+-+Kill+(7:19)/1-Kesstrel',
  ...
  parser: () => retryingPromise(() => import('./CombatLogParser' /* webpackChunkName: "WindwalkerMonk" */).then(exports => exports.default)),
