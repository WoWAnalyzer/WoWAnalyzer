...
export default [
  ...
  change(
    date(2020, 12, 27),
    <>Fixed some weirdness with reset events happening when cooldown is already reset.</>,
    Abelito75,
  ),
  ...
  change(
    date(2020, 12, 18),
    <>Fixed bug in tier 30 comparison that would make sotc always give 0 mana.</>,
    Abelito75,
  ),
  ...
  change(
    date(2020, 12, 4),
    <>Turned on Ancient Teachings of the Monastery and Clouded Focus.</>,
    Abelito75,
  ),
  ...
  change(
    date(2020, 10, 25),
    <>Added average Enveloping Breath targets to checklist and suggestions.</>,
    Vohrr,
  ),
  change(
    date(2020, 10, 21),
    <>
      Updates to Lifecyles module to account for innervate and Chi-Ji stacks and updated suggestion
      threshhold for Shadowlands.{' '}
    </>,
    Vohrr,
  ),
  change(
    date(2020, 10, 20),
    <>Fixed Mana Tea duration in T45Comparison and updated Mana Tea suggestion.</>,
    Vohrr,
  ),
  ...
  change(
    date(2020, 10, 14),
    <>Converted some more files to typescript as well as fixing internalization. </>,
    Abelito75,
  ),
  ...
  change(
    date(2020, 10, 12),
    <>
      Updated <SpellLink id={SPELLS.ENVELOPING_MIST.id} /> and{' '}
      <SpellLink id={SPELLS.SOOTHING_MIST.id} /> modules to use Event Listeners.
    </>,
    [Anomoly],
  ),
  ...
  change(
    date(2020, 10, 7),
    <>Updated Harm Denial to include the expel harm cast on an ally.</>,
    Moonrabbit,
  ),
  change(
    date(2020, 10, 6),
    <>
      Updated <SpellLink id={SPELLS.SPINNING_CRANE_KICK.id} /> and{' '}
      <SpellLink id={SPELLS.ESSENCE_FONT.id} /> modules to use Event Listeners.
    </>,
    [Anomoly],
  ),
  change(
    date(2020, 10, 4),
    <>Added stack management breakdown to InvokeChiji talent module. </>,
    Vohrr,
  ),
  ...
  change(
    date(2020, 10, 6),
    <>
      Updated <SpellLink id={SPELLS.RENEWING_MIST.id} /> to use Event Listeners.
    </>,
    [Anomoly],
  ),
  ...
  change(
    date(2020, 10, 6),
    <>
      Moved <SpellLink id={SPELLS.INVOKE_CHI_JI_THE_RED_CRANE_TALENT.id} /> statistic box to the
      correct location.
    </>,
    [Moonrabbit],
  ),
  ...
  change(
    date(2020, 10, 4),
    <>Corrected overhealing a few spells in MistweaverHealingEfficiencyTracker.</>,
    [Vohrr],
  ),
  change(
    date(2020, 10, 3),
    <>
      Updated <SpellLink id={SPELLS.INVOKE_CHI_JI_THE_RED_CRANE_TALENT.id} /> statbox to include
  ...
  change(
    date(2020, 10, 1),
    <>Added Statistics for Tear of Morning and Ancient Teachings of the Monastery.</>,
    [Abelito75],
  ),
  change(date(2020, 9, 30), <>Integration Tests have been added for Mistweaver.</>, [Anomoly]),
  change(date(2020, 9, 30), <>Statistic created for the potency conduit Imbued Reflections. </>, [
    Abelito75,
  ]),
  change(
    date(2020, 9, 26),
    <>
      Added <SpellLink id={SPELLS.INVOKE_YULON_THE_JADE_SERPENT.id} /> and{' '}
      <SpellLink id={SPELLS.INVOKE_CHI_JI_THE_RED_CRANE_TALENT.id} /> to the cooldown tracker.
    </>,
    [Abelito75],
  ),
  change(date(2020, 9, 26), <>Added Rising Sun Revival, Jade Bond, and Nourishing Chi.</>, [
    Abelito75,
  ]),
  change(date(2020, 9, 26), <>Updated Checklist to include Touch of Death, Yu'lon and Chi-ji.</>, [
    Abelito75,
  ]),
