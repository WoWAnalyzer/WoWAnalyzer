...
class MistweaverHealingEfficiencyTracker extends HealingEfficiencyTracker {
  ...
  getCustomSpellStats(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}, spellId: number) {
  ...
  getSoothingMistDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getEnvelopingMistsDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getEssenceFontDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getRenewingMistDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getVivifyDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getRefreshingJadeWindDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
    spellInfo.healingDone = this.refreshingJadeWind.healingRJW;
    spellInfo.overhealingDone = this.refreshingJadeWind.overhealingRJW;
    return spellInfo;
  }

  getRisingSunKickDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getYulonDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getChijiDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
  ...
  getExpelHarmDetails(spellInfo: {spell: Spell; casts: number; healingHits: number; healingDone: number; overhealingDone: number; damageHits: number; damageDone: number; damageAbsorbed: number; manaSpent: number; manaGained: ManaTracker;}) {
