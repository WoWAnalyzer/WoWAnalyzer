...
class Tier45Comparison extends Analyzer {
  ...
  generateLifeCycles() {
    ...
    const manaDiscountOnViv = Math.min(vivCasts, envCasts) * SPELLS.VIVIFY.resourceCost * LIFECYCLES_MANA_PERC_REDUCTION;
    const manaDiscountOnEnv = Math.min(vivCasts, envCasts) * SPELLS.ENVELOPING_MIST.resourceCost * LIFECYCLES_MANA_PERC_REDUCTION;
