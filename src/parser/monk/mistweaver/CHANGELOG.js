...
export default [
  change(date(2020, 10, 3), <>Updated Chiji statbox to include enveloping breath healing. </>, "pingypong"),
  ...
  change(date(2019, 2, 21), <>Added statistics for tracking the average stat gain from Secrwet Infusion.</>, [Anomoly]),
