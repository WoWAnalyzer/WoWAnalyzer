...
export default [
  ...
  change(date(2019, 3, 10), <>Fixed a bug in the Ironskin Brew normalizer that led to a crash in the new timeline.</>, [Zerotorescue]),
  ...
  change(date(2018, 12, 30), <>Added Straight no Chaser module.</>, [emallson]),
  ...
  change(date(2018, 9, 22), <>Updated Ironskin Brew and <SpellLink id={SPELLS.BREATH_OF_FIRE.id} /> suggestions to use hits mitigated instead of uptime.</>, [emallson]),
  change(date(2018, 9, 22), <>Added support for Fit To Burst.</>, [emallson]),
  change(date(2018, 9, 13), <>Added support for Elusive Footwork.</>, [emallson]),
  change(date(2018, 8, 11), <>Added support for Staggering Strikes.</>, [emallson]),
  ...
  change(date(2018, 7, 15), <>Added Training of Niuzao support.</>, [emallson]),
  change(date(2018, 6, 16), <>Updated Ironskin Brew cooldown and duration and added Guard, along with other changes in beta build 26812.</>, [emallson]),
];
