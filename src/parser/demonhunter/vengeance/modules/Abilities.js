    ...
    return [
      ...
      },
      {
        ...
        castEfficiency: {
          ...
          extraSuggestion: (
            <>
              This is a great healing and AoE damage burst spell. The only moment you can delay it's
              cast is if your <SpellLink id={SPELLS.FIERY_BRAND.id} /> (with the{' '}
              <SpellLink id={SPELLS.CHARRED_FLESH_TALENT.id} /> talent) is almost available.{' '}
            </>
          ),
        },
        isDefensive: true,
