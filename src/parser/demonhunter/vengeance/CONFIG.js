...
import { TurianSniper, Geeii } from 'CONTRIBUTORS';
...
export default {
  ...
  contributors:  [TurianSniper, Geeii ],
  ...
  exampleReport: '/report/6zKDdF1vh2C9Zfa3/26-Heroic+Grong+-+Kill+(4:44)/15-Winterhunter',
