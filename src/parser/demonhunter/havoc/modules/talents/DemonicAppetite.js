  ...
  suggestions(when) {
    when(this.suggestionThresholds)
      .addSuggestion((suggest, actual, recommended) => {
        return suggest(<> Avoid picking up souls generated by the <SpellLink id={SPELLS.DEMONIC_APPETITE_TALENT.id} /> talent when close to Fury cap and cast abilities regularly to avoid accidentally capping.</>)
