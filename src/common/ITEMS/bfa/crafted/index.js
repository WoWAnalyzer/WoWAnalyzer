...
export default {
  DARKMOON_DECK_BLOCKADES: {
    id: 159128,
    name: 'Darkmoon Deck: Blockades',
    icon: 'inv_inscription_80_deck_blockades',
  },
  DARKMOON_DECK_TIDES: {
    id: 159127,
    name: 'Darkmoon Deck: Tides',
    icon: 'inv_inscription_80_deck_tides',
  },
  DARKMOON_DECK_SQUALLS: {
    id: 159126,
    name: 'Darkmoon Deck: Squalls',
    icon: 'inv_inscription_80_deck_squalls',
  },
  DARKMOON_DECK_FATHOMS: {
    id: 159125,
