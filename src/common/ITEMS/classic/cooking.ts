...
const items = {
  ...
  SEA_MIST_RICE_NOODLES: {
    ...
    icon: 'inv_misc_food_cooked_seamistricenoodles',
    buffId: 104275,
  },
  BLACK_PEPPER_RIBS_AND_SHRIMP: {
    id: 74646,
    name: 'Black Pepper Ribs and Shrimp',
    icon: 'inv_misc_food_cooked_golden_black_pepper_ribs_and_shrimp',
    buffId: 104272,
  },
  SPICED_BLOSSOM_SOUP: {
    id: 101748,
  ...
  PANDAREN_BANQUET: {
    ...
    icon: 'inv_misc_food_cooked_pabanquet_general',
  },
  PANDAREN_TREASURE_NOODLE_CART: {
    id: 145196,
    name: 'Pandaren Treasure Noodle Cart',
    icon: 'inv_misc_noodle_cart_epic_level',
  },
  GREAT_PANDAREN_BANQUET: {
    id: 75016,
    name: 'Great Pandaren Banquet',
    icon: 'inv_misc_food_cooked_greatpabanquet_general',
  },
  SEASONED_POMFRUIT_SLICES: {
    id: 101746,
    name: 'Seasoned Pomfruit Slices',
    icon: 'inv_misc_food_vendor_slicedpeaches',
    buffId: 146805,
  },
  BRAISED_TURTLE: {
    id: 74649,
  ...
  CHUN_TIAN_SPRING_ROLLS: {
    ...
    icon: 'inv_misc_food_cooked_springrolls',
    buffId: 104283,
  },
  ...
  RICE_PUDDING: {
    id: 86069,
    name: 'Rice Pudding',
    icon: 'inv_misc_food_vendor_poundedricecake_1',
    buffId: 125108,
  },
  ...
  TWIN_FISH_PLATTER: {
    ...
    icon: 'inv_misc_food_cooked_twinfishplatter',
    buffId: 104282,
  },
  FIRE_SPIRIT_SALMON: {
    id: 74652,
    name: 'Fire Spirit Salmon',
    icon: 'inv_misc_food_cooked_firespiritsalmon',
    buffId: 104279,
  },
  ...
  STEAMED_CRAB_SURPRISE: {
    ...
    icon: 'inv_misc_food_cooked_steamcrabsurprise',
    buffId: 104280,
  },
  PEARL_MILK_TEA: {
    id: 81414,
  ...
  GREEN_CURRY_FISH: {
    ...
    icon: 'inv_misc_food_vendor_greenfishbonescurry',
    buffId: 124218,
  },
  SKEWERED_PEANUT_CHICKEN: {
    id: 81413,
    name: 'Skewered Peanut Chicken',
    icon: 'inv_misc_skeweredpeanutchicken',
    buffId: 124221,
  },
  PEACH_PIE: {
    id: 81411,
    name: 'Peach Pie',
    icon: 'inv_misc_food_vendor_peachpie',
    buffId: 125071,
  },
  WILDFOWL_GINSENG_SOUP: {
    id: 86070,
    name: 'Wildfowl Ginseng Soup',
    icon: 'inv_misc_food_vendor_needlemushroomsoup',
    buffId: 125106,
  },
  RED_BEAN_BUN: {
    id: 81408,
    name: 'Red Bean Bun',
    icon: 'inv_misc_food_vendor_redbeanbun',
    buffId: 124216,
  },
  BLANCHEND_NEEDLE_MUSHROOMS: {
    id: 81412,
    name: 'Blanched Needle Mushrooms',
    icon: 'inv_misc_food_vendor_blanchedneedlemushroom',
    buffId: 124220,
  },
  FARMERS_DELIGHT: {
    id: 101747,
