...
const items = itemIndexableList({
  ...
  TENDER_SHOVELTUSK_STEAK: { id: 34755, name: 'Tender Shoveltusk Steak', icon: 'inv_misc_food_122_steak' },
  BLACKENED_DRAGONFIN: { id: 42999, name: 'Blackened Dragonfin', icon: 'inv_misc_food_142_fish' },
  SPICED_MAMMOTH_TREATS: { id: 43005, name: 'Spiced Mammoth Treats', icon: 'inv_misc_food_123_roast' },
  ...
  MEGA_MAMMOTH_MEAL: { id: 34754, name: 'Mega Mammoth Meal', icon: 'inv_misc_food_108_meadcaribou' },
  IMPERIAL_MANTA_STEAK: { id: 34769, name: 'Imperial Manta Steak', icon: 'inv_misc_food_121_buttermeat' },
  ...
  DALARAN_CLAM_CHOWDER: { id: 43268, name: 'Dalaran Clam Chowder', icon: 'inv_misc_cauldron_frost' },
  POACHED_NORTHERN_SCULPIN: { id: 34766, name: 'Poached Northern Sculpin', icon: 'inv_misc_food_77' },
  ...
  SPICY_BLUE_NETTLEFISH: { id: 34768, name: 'Spicy Blue Nettlefish', icon: 'inv_misc_food_139_fish' },
