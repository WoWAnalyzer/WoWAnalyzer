...
const talents = createTalentList({
  ...
  IMPROVED_RAMPAGE_FURY_TALENT: {
    id: 383856,
    name: 'Improved Rampage',
    icon: 'ability_warrior_rampage',
    maxRanks: 1,
    reqPoints: 8,
    spellType: 'passive',
  ...
  DEFENSIVE_REFLEXES_PROTECTION_TALENT: {
    id: 382741,
  ...
  IMPROVED_CHALLENGING_SHOUT_PROTECTION_TALENT: {
    id: 386071,
