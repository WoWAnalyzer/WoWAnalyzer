...
const talents = createTalentList({
  ...
  FIRESTARTER_TALENT: { id: 205026, name: 'Firestarter', icon: 'spell_fire_fire', maxRanks: 1 },
  PYROTECHNICS_TALENT: {
    id: 157642,
    name: 'Pyrotechnics',
  ...
  FLAME_PATCH_TALENT: { id: 205037, name: 'Flame Patch', icon: 'spell_mage_flameorb', maxRanks: 1 },
  ...
  PYROCLASM_TALENT: { id: 269650, name: 'Pyroclasm', icon: 'spell_shaman_lavasurge', maxRanks: 1 },
  ...
  COLD_SNAP_TALENT: { id: 235219, name: 'Cold Snap', icon: 'spell_frost_wizardmark', maxRanks: 1 },
  FROSTBITE_TALENT: { id: 378756, name: 'Frostbite', icon: 'spell_frost_frostarmor', maxRanks: 1 },
  ...
  ICY_VEINS_TALENT: { id: 12472, name: 'Icy Veins', icon: 'spell_frost_coldhearted', maxRanks: 1 },
