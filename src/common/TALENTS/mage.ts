...
const talents = createTalentList({
  ...
  RIGID_ICE_TALENT: { id: 382481, name: 'Rigid Ice', icon: 'spell_frost_frostnova', maxRanks: 2 },
  ...
  FIREBALL_FIRE_TALENT: { id: 157642, name: 'Fireball', icon: 'spell_fire_flamebolt', maxRanks: 1 },
