...
const talents = createTalentList({
  ...
  PURGE_TALENT: { id: 370, name: 'Purge', icon: 'spell_nature_purge', maxRanks: 1, manaCost: 5000 },
  ...
  ACID_RAIN_TALENT: { id: 378443, name: 'Acid Rain', icon: 'spell_nature_acid_01', maxRanks: 1 },
  ...
  TORRENT_TALENT: { id: 200072, name: 'Torrent', icon: 'spell_nature_riptide', maxRanks: 2 },
  UNDULATION_TALENT: {
    id: 200071,
    name: 'Undulation',
