...
const talents = createTalentList({
  ...
  NATURES_SPLENDOR_RESTORATION_TALENT: {
    id: 392288,
    name: "Nature's Splendor",
    icon: 'spell_nature_spiritarmor',
    maxRanks: 1,
  },
  PASSING_SEASONS_RESTORATION_TALENT: {
    id: 382550,
    name: 'Passing Seasons',
    icon: 'spell_nature_ravenform',
    maxRanks: 1,
  },
  FLASH_OF_CLARITY_RESTORATION_TALENT: {
    id: 392220,
    name: 'Flash of Clarity',
    icon: 'spell_nature_crystalball',
    maxRanks: 1,
  },
  WAKING_DREAM_RESTORATION_TALENT: {
    id: 392221,
    name: 'Waking Dream',
    icon: 'inv_misc_head_dragon_green',
    maxRanks: 1,
  ...
  REGENESIS_RESTORATION_TALENT: {
    id: 383191,
    name: 'Regenesis',
    icon: 'inv_misc_herb_liferoot_stem',
    maxRanks: 2,
  },
  HARMONIOUS_BLOOMING_RESTORATION_TALENT: {
    id: 392256,
  ...
  REGENERATIVE_HEARTWOOD_RESTORATION_TALENT: {
    id: 392116,
  ...
  BUDDING_LEAVES_RESTORATION_TALENT: {
    id: 392167,
    name: 'Budding Leaves',
    icon: 'inv_misc_herb_fellotus',
    maxRanks: 2,
  },
  CENARIUS_GUIDANCE_RESTORATION_TALENT: {
    id: 393371,
    name: "Cenarius' Guidance",
    icon: 'ability_druid_treeoflife',
    maxRanks: 1,
  },
  EMBRACE_OF_THE_DREAM_RESTORATION_TALENT: {
    id: 392124,
  ...
  LUXURIANT_SOIL_RESTORATION_TALENT: {
    id: 392315,
    name: 'Luxuriant Soil',
    icon: 'achievement_dungeon_everbloom',
    maxRanks: 2,
  },
  NATURAL_WISDOM_RESTORATION_TALENT: {
    id: 326228,
    name: 'Natural Wisdom',
    icon: 'spell_nature_lightning',
    maxRanks: 1,
  },
  NURTURING_DORMANCY_RESTORATION_TALENT: {
    id: 392099,
  ...
  UNDERGROWTH_RESTORATION_TALENT: {
    id: 392301,
    name: 'Undergrowth',
  ...
  REFORESTATION_RESTORATION_TALENT: {
    id: 392356,
    name: 'Reforestation',
    icon: 'inv_herbalism_70_yserallineseed',
    maxRanks: 1,
  },
  POWER_OF_THE_ARCHDRUID_RESTORATION_TALENT: {
    id: 392302,
    name: 'Power of the Archdruid',
    icon: 'spell_druid_rampantgrowth',
    maxRanks: 1,
  },
  INVIGORATE_RESTORATION_TALENT: {
    id: 392160,
    name: 'Invigorate',
  ...
  MERCILESS_STRIKES_FERAL_TALENT: {
    id: 231063,
  ...
  DOUBLE_CLAWED_RAKE_FERAL_TALENT: {
    id: 391700,
    name: 'Double-Clawed Rake',
    icon: 'ability_druid_disembowel',
    maxRanks: 1,
  },
  PROTECTIVE_GROWTH_FERAL_TALENT: {
    id: 391947,
  ...
  DREADFUL_BLEEDING_FERAL_TALENT: {
    id: 391045,
    name: 'Dreadful Bleeding',
    icon: 'ability_ghoulfrenzy',
    maxRanks: 1,
  },
  RELENTLESS_PREDATOR_FERAL_TALENT: {
    id: 393771,
    name: 'Relentless Predator',
    icon: 'ability_druid_predatoryinstincts',
    maxRanks: 1,
  },
  RAGING_FURY_FERAL_TALENT: {
    id: 391078,
    name: 'Raging Fury',
    icon: 'ability_druid_predatoryinstincts',
    maxRanks: 1,
  },
  TIGERS_TENACITY_FERAL_TALENT: {
    id: 391872,
    name: "Tiger's Tenacity",
    icon: 'ability_druid_healinginstincts',
    maxRanks: 1,
  },
  BERSERK_HEART_OF_THE_LION_FERAL_TALENT: {
    id: 391174,
  ...
  VEINRIPPER_FERAL_TALENT: {
    id: 391978,
    name: 'Veinripper',
    icon: 'inv_artifact_bloodoftheassassinated',
    maxRanks: 1,
  },
  RIP_AND_TEAR_FERAL_TALENT: {
    id: 391347,
    name: 'Rip and Tear',
    icon: 'ability_ghoulfrenzy',
    maxRanks: 1,
  ...
  ASHAMANES_GUIDANCE_FERAL_TALENT: {
    id: 391548,
  ...
  IMPROVED_SURVIVAL_INSTINCTS_GUARDIAN_TALENT: {
    id: 328767,
  ...
  FLASHING_CLAWS_GUARDIAN_TALENT: {
    id: 393427,
    name: 'Flashing Claws',
  ...
  URSOCS_GUIDANCE_GUARDIAN_TALENT: {
    id: 393414,
  ...
  AETHERIAL_KINDLING_BALANCE_TALENT: {
    id: 327541,
