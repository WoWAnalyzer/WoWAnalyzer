...
const talents = createTalentList({
  ...
  IMPROVED_BLEEDS_FERAL_TALENT: {
    id: 231063,
    name: 'Improved Bleeds',
  ...
  IMPROVED_LIFEBLOOM_RESTORATION_TALENT: {
    id: 392256,
  ...
  UNENDING_GROWTH_RESTORATION_TALENT: {
    id: 392315,
    name: 'Unending Growth',
