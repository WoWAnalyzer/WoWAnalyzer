export default {
  ...
  BESTOW_FAITH_TALENT: {
    ...
    manaCost: 13200,
    description: '<a href="http://www.wowhead.com/spell=223306" target="_blank" rel="noopener noreferrer">Bestow Faith</a> is the default choice for most encounters in raids. The 5-second delay requires foresight, but this ability gives great healing for a very low mana cost. ',
  },
  ...
  CRUSADERS_MIGHT_TALENT: {
    ...
    description: 'Unfortunately <a href="http://www.wowhead.com/spell=196926" target="_blank" rel="noopener noreferrer">Crusader\'s Might</a> is usually only viable with a unique playstyle that does not work well with the T19 4 set bonus. For this reason it is not recommended to take Crusader\'s Might.',
  },
  // lv30
  CAVALIER_TALENT: {
    id: 230332,
  ...
  UNBREAKABLE_SPIRIT_TALENT: {
    ...
    icon: 'spell_holy_unyieldingfaith',
    description: '<a href="http://www.wowhead.com/spell=114154" target="_blank" rel="noopener noreferrer">Unbreakable Spirit</a> is almost never a valid choice.',
  },
  RULE_OF_LAW_TALENT: {
    id: 214202,
    name: 'Rule of Law',
  ...
  DEVOTION_AURA_TALENT: {
    ...
    description: '<a href="http://www.wowhead.com/spell=183425" target="_blank" rel="noopener noreferrer">Devotion Aura</a> and <a href="http://www.wowhead.com/spell=183415" target="_blank" rel="noopener noreferrer">Aura of Mercy</a> are both situationally good. Devotion Aura is the best choice to mitigate damage from any heavy-hitting boss mechanic. If you won\'t need the damage reduction from Devotion Aura, then you should take Aura of Mercy as it will result in more overall healing.',
  },
  AURA_OF_SACRIFICE_TALENT: {
    id: 183416,
    name: 'Aura of Sacrifice',
    icon: 'ability_deathwing_bloodcorruption_earth',
    description: '<a href="http://www.wowhead.com/spell=183416" target="_blank" rel="noopener noreferrer">Aura of Sacrifice</a> works as a decent raid cooldown with <a href="http://www.wowhead.com/spell=31821" target="_blank" rel="noopener noreferrer">Aura Mastery</a>. It is best to use it during <a href="http://www.wowhead.com/spell=31842" target="_blank" rel="noopener noreferrer">Avenging Wrath</a> and/or <a href="http://www.wowhead.com/spell=105809" target="_blank" rel="noopener noreferrer">Holy Avenger</a>. For this reason it is more situationally useful as not all encounters work out such that you can line up all your cool downs at once, and have it not be wasted. *note* healing done by <a href="http://www.wowhead.com/spell=85222" target="_blank" rel="noopener noreferrer">Light of Dawn</a> does not transfer through Aura of Sacrifice\'s empowered effect.',
  },
  ...
  DIVINE_PURPOSE_TALENT_HOLY: {
    ...
    name: 'Divine Purpose',
    icon: 'spell_holy_divinepurpose',
    description: '<a href="http://www.wowhead.com/spell=197646" target="_blank" rel="noopener noreferrer">Divine Purpose</a> provides a small chance for a free Holy Shock or Light of Dawn, which saves mana by not having to cast something that consumes mana. The downside to Divine Purpose is that it is not very reliable, unlike <a href="http://www.wowhead.com/spell=105809" target="_blank" rel="noopener noreferrer">Holy Avenger</a>. This tier is mostly preference.',
  },
  HOLY_AVENGER_TALENT: {
    id: 105809,
    name: 'Holy Avenger',
    ...
    cooldownType: 'HEALING',
    description: '<a href="http://www.wowhead.com/spell=105809" target="_blank" rel="noopener noreferrer">Holy Avenger</a> provides a lot of on-demand healing. The downside to Holy Avenger is that is requires fairly heavy mana usage to be effective. This tier is mostly preference.',
  },
  HOLY_PRISM_TALENT: {
    id: 114165,
    name: 'Holy Prism',
    icon: 'spell_paladin_holyprism',
    manaCost: 37400,
    description: '<a href="http://www.wowhead.com/spell=114165" target="_blank" rel="noopener noreferrer">Holy Prism</a> provides you another AoE heal similar to <a href="http://www.wowhead.com/spell=85222" target="_blank" rel="noopener noreferrer">Light of Dawn</a>. It doesn\'t heal for a lot while it\'s mana cost is fairly high, so it is usually not recommended to pick this talent. This tier is mostly preference.',
  },
  // lv90
  ...
  BEACON_OF_THE_LIGHTBRINGER_TALENT: {
    ...
    description: '<a href="http://www.wowhead.com/spell=197446" target="_blank" rel="noopener noreferrer">Beacon of the Lightbringer</a> only provides a single beacon so requires you to manage swapping your Beacon onto the tank that is taking damage. The upside is that it increases your mastery effectiveness and the healing of <a href="http://www.wowhead.com/spell=85222" target="_blank" rel="noopener noreferrer">Light of Dawn</a>. In the Nighthold there is rarely a good reason to pick this talent over <a href="http://www.wowhead.com/spell=156910" target="_blank" rel="noopener noreferrer">Beacon of Faith</a>.',
  },
  BEACON_OF_VIRTUE_TALENT: {
    id: 200025,
    name: 'Beacon of Virtue',
    icon: 'ability_paladin_beaconofinsight',
    description: '<a href="http://www.wowhead.com/spell=200025" target="_blank" rel="noopener noreferrer">Beacon of Virtue</a> is rarely a good choice in raids. It requires you to use a Global Cooldown to apply to random targets and costs a considerable amount of mana.',
  },
  // Retribution Paladin:
  // lv15
