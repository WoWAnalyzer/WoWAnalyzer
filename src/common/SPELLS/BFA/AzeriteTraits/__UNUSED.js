...
export default {
  ...
  EMBRACE_OF_THE_SANDS: {
    id: 264600,
    name: 'Embrace of the Sands',
    icon: 'spell_sandstorm',
  },
  EMBRACE_OF_THE_TIDES: {
    id: 264123,
    name: 'Embrace of the Tides',
  ...
  FLAMES_OF_THE_FOREFATHERS: {
    id: 264113,
    name: 'Flames of the Forefathers',
  ...
  POWERFUL_PLACEHOLDER: {
    id: 277641,
    name: 'Powerful Placeholder',
    icon: '70_inscription_deck_promises_a',
  },
  PRAYERFUL_LITANY: {
    id: 275602,
  ...
  REZANS_COMMAND: {
    id: 273154,
    name: 'Rezan\'s Command',
    icon: 'inv_zandalaribabyraptorblue',
  },
  REZANS_FURY: {
    id: 273790,
    name: 'Rezan\'s Fury',
    icon: 'achievement_dungeon_rezan',
  },
  RIDE_THE_LIGHTNING: {
    id: 263821,
  ...
  TEMPLATE_STACKING_AZERITE_POWER: {
    id: 271261,
    name: 'Template Stacking Azerite Power',
    icon: 'ability_vehicle_shellshieldgenerator_green',
  },
  TEST_OF_MIGHT: {
    id: 275529,
