...
const talents: SpellList = {
  ...
  SHINING_FORCE_TALENT: { id: 204263, name: 'Shining Force', icon: 'ability_paladin_blindinglight2', manaCost: 0.025 },
  CONTRITION_TALENT: { id: 197419, name: 'Contrition', icon: 'ability_priest_savinggrace' },
  SHADOW_COVENANT_TALENT: { id: 314867, name: 'Shadow Covenant', icon: 'spell_shadow_summonvoidwalker', manaCost: 0.05 },
  BENEDICTION_TALENT: { id: 193157, name: 'Benediction', icon: 'spell_monk_diffusemagic' },
  DIVINE_STAR_TALENT: { id: 110744, name: 'Divine Star', icon: 'spell_priest_divinestar', manaCost: 0.02 },
  HALO_TALENT: { id: 120517, name: 'Halo', icon: 'ability_priest_halo', manaCost: 0.027000000000000003 },
  SPIRIT_SHELL_TALENT: { id: 109964, name: 'Spirit Shell', icon: 'ability_shaman_astralshift', manaCost: 0.02 },
  ...
  BINDING_HEAL_TALENT: { id: 32546, name: 'Binding Heal', icon: 'spell_holy_blindingheal', manaCost: 0.034 },
  ...
  HOLY_WORD_SALVATION_TALENT: { id: 265202, name: 'Holy Word: Salvation', icon: 'ability_priest_archangel', manaCost: 0.06 },
  ...
  SEARING_NIGHTMARE_TALENT: { id: 341385, name: 'Searing Nightmare', icon: 'ability_priest_voidentropy', insanityCost: 3000 },
  ...
  //Discipline
  SCHISM_TALENT: { id: 214621, name: 'Schism', icon: 'spell_warlock_focusshadow', manaCost: 0.005 },
  ...
  PURGE_THE_WICKED_TALENT: { id: 204197, name: 'Purge the Wicked', icon: 'ability_mage_firestarter', manaCost: 0.018000000000000002 },
