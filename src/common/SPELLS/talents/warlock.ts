...
const talents: SpellList = {
	...
	PHANTOM_SINGULARITY_TALENT: { id: 205179, name: "Phantom Singularity", icon: "inv_enchant_voidsphere", manaCost: 0.01 },
	DARKFURY_TALENT: { id: 264874, name: "Darkfury", icon: "ability_warlock_shadowfurytga" },
	MORTAL_COIL_TALENT: { id: 6789, name: "Mortal Coil", icon: "ability_warlock_mortalcoil", manaCost: 0.02 },
	...
	BILESCOURGE_BOMBERS_TALENT: { id: 267211, name: "Bilescourge Bombers", icon: "ability_hunter_pet_bat", soulShardsCost: 20 },
	...
	DOOM_TALENT: { id: 603, name: "Doom", icon: "spell_shadow_auraofdarkness", manaCost: 0.01 },
	...
	SUMMON_VILEFIEND_TALENT: { id: 264119, name: "Summon Vilefiend", icon: "inv_argusfelstalkermount", soulShardsCost: 10 },
	SOUL_CONDUIT_TALENT: { id: 215941, name: "Soul Conduit", icon: "spell_shadow_soulleech_2" },
	INNER_DEMONS_TALENT: { id: 267216, name: "Inner Demons", icon: "ability_warlock_eradication" },
	GRIMOIRE_FELGUARD_TALENT: { id: 111898, name: "Grimoire: Felguard", icon: "spell_shadow_summonfelguard", soulShardsCost: 10 },
	...
	NETHER_PORTAL_TALENT: { id: 267217, name: "Nether Portal", icon: "inv_netherportal", soulShardsCost: 10 },
	...
	SOUL_FIRE_TALENT: { id: 6353, name: "Soul Fire", icon: "spell_fire_firebolt", manaCost: 0.02 },
	REVERSE_ENTROPY_TALENT: { id: 205148, name: "Reverse Entropy", icon: "spell_fire_playingwithfiregreen" },
	INTERNAL_COMBUSTION_TALENT: { id: 266134, name: "Internal Combustion", icon: "ability_mage_livingbomb" },
	SHADOWBURN_TALENT: { id: 17877, name: "Shadowburn", icon: "spell_shadow_scourgebuild", soulShardsCost: 10 },
	...
	CATACLYSM_TALENT: { id: 152108, name: "Cataclysm", icon: "achievement_zone_cataclysm", manaCost: 0.01 },
	ROARING_BLAZE_TALENT: { id: 205184, name: "Roaring Blaze", icon: "ability_warlock_inferno" },
	RAIN_OF_CHAOS_TALENT: { id: 266086, name: "Rain of Chaos", icon: "spell_fire_felrainoffire" },
	CHANNEL_DEMONFIRE_TALENT: { id: 196447, name: "Channel Demonfire", icon: "spell_fire_ragnaros_lavaboltgreen", manaCost: 0.015 },
	DARK_SOUL_INSTABILITY_TALENT: { id: 113858, name: "Dark Soul: Instability", icon: "spell_warlock_soulburn", manaCost: 0.01 },
	...
	SIPHON_LIFE_TALENT: { id: 63106, name: "Siphon Life", icon: "spell_shadow_requiem", manaCost: 0.01 },
	SOW_THE_SEEDS_TALENT: { id: 196226, name: "Sow the Seeds", icon: "spell_shadow_seedofdestruction" },
	VILE_TAINT_TALENT: { id: 278350, name: "Vile Taint", icon: "sha_spell_shadow_shadesofdarkness_nightborne", soulShardsCost: 10 },
	DARK_CALLER_TALENT: { id: 334183, name: "Dark Caller", icon: "warlock_summon__beholder" },
	HAUNT_TALENT: { id: 48181, name: "Haunt", icon: "ability_warlock_haunt", manaCost: 0.02 },
	CREEPING_DEATH_TALENT: { id: 264000, name: "Creeping Death", icon: "ability_creature_cursed_03" },
	DARK_SOUL_MISERY_TALENT: { id: 113860, name: "Dark Soul: Misery", icon: "spell_warlock_soulburn", manaCost: 0.01 },
