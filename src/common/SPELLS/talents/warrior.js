...
export default {
  ...
  WAR_MACHINE_FURY_TALENT: { id: 346002, name: 'War Machine', icon: 'ability_hunter_rapidkilling' },
  WAR_MACHINE_PROT_TALENT: { id: 316733, name: 'War Machine', icon: 'ability_hunter_rapidkilling' },
  // Double Time
  ...
  // Arms/Fury
  // Sudden Death
  SUDDEN_DEATH_ARMS_TALENT: { id: 29725, name: 'Sudden Death', icon: 'ability_warrior_improveddisciplines' },
  SUDDEN_DEATH_FURY_TALENT: { id: 280721, name: 'Sudden Death', icon: 'ability_warrior_improveddisciplines' },
  // Massacre
  MASSACRE_ARMS_TALENT: { id: 281001, name: 'Massacre', icon: 'inv_sword_48' },
  MASSACRE_FURY_TALENT: { id: 206315, name: 'Massacre', icon: 'inv_sword_48' },

  // Arms/Prot
  RAVAGER_ARMS_TALENT: { id: 152277, name: 'Ravager', icon: 'warrior_talent_icon_ravager' },
  RAVAGER_PROT_TALENT: { id: 228920, name: 'Ravager', icon: 'warrior_talent_icon_ravager' },
  ...
  // Arms
  // Tier 1 (level 15) = War machine | Sudden Death | Skullsplitter
  SKULLSPLITTER_TALENT: { id: 260643, name: 'Skullsplitter', icon: 'inv_skullsplitter' },
  // Tier 2 (level 25) = Double Time | Impending Victory | Storm Bolt

  // Tier 3 (level 30) = Massacre | Fervor Of Battle | Rend
  FERVOR_OF_BATTLE_TALENT: { id: 202316, name: 'Fervor of Battle	', icon: 'ability_rogue_waylay' },
  REND_TALENT: { id: 772, name: 'Rend', icon: 'ability_gouge' },
  // Tier 4 (level 35) = Second Wind | Bounding Stride | Defensive Stance
  ...
  // Tier 5 (level 40) = Collateral Damage | Warbreaker | Cleave
  COLLATERAL_DAMAGE_TALENT: { id: 334779, name: 'Collateral Damage', icon: 'ability_warrior_incite' },
  ...
  // Tier 6 (level 45) = In For The Kill | Avatar | Deadly Calm
  ...
  // Tier 4 (level 35) = Furious Charge | Bounding Stride | Warpaint
  ...
  // Tier 5 (level 40) = Seethe | Frothing Berserker | Cruelty
  SEETHE_TALENT: { id: 335091, name: 'Seethe', icon: 'ability_warrior_furiousresolve' },
  ...
  // Tier 3 (level 30) = Best Served Cold | Booming Voice | Dragon Roar
  ...
  // Tier 4 (level 35) = Crackling Thunder | Bounding Stride | Menance Talent
  CRACKLING_THUNDER_TALENT: { id: 203201, name: 'Crackling Thunder', icon: 'ability_thunderking_overcharge' },
  MENANCE_TALENT: { id: 275338, name: 'Menace', icon: 'ability_golemthunderclap' },
  // Tier 5 (level 40) = Never Surrender | Indomitable | Impending Victory
  ...
  // Tier 6 (level 45) = Into the Fray | Unstoppable Force | Ravager
