export default {
  ...
  SHINING_FORCE_TALENT: { id: 204263, name: 'Shining Force', icon: 'ability_paladin_blindinglight2', resourceCost: 1250 },
  CONTRITION_TALENT: { id: 197419, name: 'Contrition', icon: 'ability_priest_savinggrace' },
  SHADOW_COVENANT_TALENT: { id: 204065, name: 'Shadow Covenant', icon: 'spell_shadow_summonvoidwalker', resourceCost: 2500 },
  BENEDICTION_TALENT: { id: 193157, name: 'Benediction', icon: 'spell_monk_diffusemagic' },
  DIVINE_STAR_TALENT: { id: 110744, name: 'Divine Star', icon: 'spell_priest_divinestar', resourceCost: 1000 },
  HALO_TALENT: { id: 120517, name: 'Halo', icon: 'ability_priest_halo', resourceCost: 1350 },
  LUMINOUS_BARRIER_TALENT: { id: 271466, name: 'Luminous Barrier', icon: 'spell_priest_burningwill', resourceCost: 4000 },
  ...
  BINDING_HEAL_TALENT: { id: 32546, name: 'Binding Heal', icon: 'spell_holy_blindingheal', resourceCost: 1700 },
  ...
  HOLY_WORD_SALVATION_TALENT: { id: 265202, name: 'Holy Word: Salvation', icon: 'ability_priest_archangel', resourceCost: 3000 },
  PRAYER_CIRCLE_TALENT: { id: 321377, name: 'Prayer Circle', icon: 'spell_paladin_divinecircle' },

  // Discipline
  SCHISM_TALENT: { id: 214621, name: 'Schism', icon: 'spell_warlock_focusshadow', resourceCost: 250 },
  ...
  PURGE_THE_WICKED_TALENT: { id: 204197, name: 'Purge the Wicked', icon: 'ability_mage_firestarter', resourceCost: 900 },
