...
const talents: SpellList = {
  ...
  SECRET_TECHNIQUE_TALENT: { id: 280719, name: 'Secret Technique', icon: 'ability_rogue_sinistercalling', energyCost: 30, comboPointsCost: 1 },
  SHURIKEN_TORNADO_TALENT: { id: 277925, name: 'Shuriken Tornado', icon: 'ability_rogue_throwingspecialization', energyCost: 60 },
