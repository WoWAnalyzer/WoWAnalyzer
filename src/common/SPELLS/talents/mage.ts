...
const talents: SpellList = {
  ...
  FROM_THE_ASHES_TALENT: { id: 342344, name: 'From the Ashes', icon: 'inv_misc_phoenixegg' },
  ...
  CHAIN_REACTION_TALENT: { id: 278309, name: 'Chain Reaction', icon: 'spell_frost_frostblast' },
  ...
  MASTER_OF_TIME_TALENT: { id: 342249, name: 'Master of Time', icon: 'inv_belt_armor_waistoftime_d_01' },
