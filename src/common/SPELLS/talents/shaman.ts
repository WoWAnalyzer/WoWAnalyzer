...
const talents: SpellList = {
  ...
  EARTH_SHIELD_TALENT: { id: 974, name: 'Earth Shield', icon: 'spell_nature_skinofearth', manaCost: 1000 },
  ...
  SURGE_OF_EARTH_TALENT: { id: 320746, name: 'Surge of Earth', icon: 'inv_elementalearth2', manaCost: 1000 },
  ...
  STATIC_DISCHARGE_TALENT: { id: 342243, name: 'Static Discharge', icon: 'spell_lightning_lightningbolt01', manaCost: 125 },
  AFTERSHOCK_TALENT: { id: 273221, name: 'Aftershock', icon: 'spell_nature_stormreach' },
  ECHOING_SHOCK_TALENT: { id: 320125, name: 'Echoing Shock', icon: 'misc_legionfall_shaman', manaCost: 325 },
  ...
  LIQUID_MAGMA_TOTEM_TALENT: { id: 192222, name: 'Liquid Magma Totem', icon: 'spell_shaman_spewlava', manaCost: 350 },
  ...
  ICEFURY_TALENT: { id: 210714, name: 'Icefury', icon: 'spell_frost_iceshard', manaCost: 300 },
