...
const talents: SpellList = {
  //Shared
  ELEMENTAL_BLAST_TALENT: { id: 117014, name: 'Elemental Blast', icon: 'shaman_talent_elementalblast', manaCost: 0.0275 },
  SPIRIT_WOLF_TALENT: { id: 260878, name: 'Spirit Wolf', icon: 'spell_hunter_lonewolf' },
  EARTH_SHIELD_TALENT: { id: 974, name: 'Earth Shield', icon: 'spell_nature_skinofearth', manaCost: 0.1 },
  ...
  CLOUDBURST_TOTEM_TALENT: { id: 157153, name: 'Cloudburst Totem', icon: 'ability_shaman_condensationtotem', manaCost: 0.086 },
  ...
  UNLEASH_LIFE_TALENT: { id: 73685, name: 'Unleash Life', icon: 'spell_shaman_unleashweapon_life', manaCost: 0.04 },
  DELUGE_TALENT: { id: 200076, name: 'Deluge', icon: 'ability_shawaterelemental_reform' },
  SURGE_OF_EARTH_TALENT: { id: 320746, name: 'Surge of Earth', icon: 'inv_elementalearth2', manaCost: 0.1 },
  EARTHGRAB_TOTEM_TALENT: { id: 51485, name: 'Earthgrab Totem', icon: 'spell_nature_stranglevines', manaCost: 0.025 },
  ANCESTRAL_VIGOR_TALENT: { id: 207401, name: 'Ancestral Vigor', icon: 'spell_shaman_blessingoftheeternals' },
  EARTHEN_WALL_TOTEM_TALENT: { id: 198838, name: 'Earthen Wall Totem', icon: 'spell_nature_stoneskintotem', manaCost: 0.11 },
  ANCESTRAL_PROTECTION_TOTEM_TALENT: { id: 207399, name: 'Ancestral Protection Totem', icon: 'spell_nature_reincarnation', manaCost: 0.11 },
  ...
  DOWNPOUR_TALENT: { id: 207778, name: 'Downpour', icon: 'ability_mage_waterjet', manaCost: 0.15 },
  HIGH_TIDE_TALENT: { id: 157154, name: 'High Tide', icon: 'spell_shaman_hightide', manaCost: 0.01 },
  WELLSPRING_TALENT: { id: 197995, name: 'Wellspring', icon: 'ability_shawaterelemental_split', manaCost: 0.2 },
  ...
  ICE_STRIKE_TALENT: { id: 342240, name: 'Ice Strike', icon: 'spell_frost_frostbolt', manaCost: 0.033 },
  ...
  FIRE_NOVA_TALENT: { id: 333974, name: 'Fire Nova', icon: 'spell_shaman_improvedfirenova', manaCost: 0.055 },
  ...
  SUNDERING_TALENT: { id: 197214, name: 'Sundering', icon: 'ability_rhyolith_lavapool', manaCost: 0.06 },
  ELEMENTAL_SPIRITS_TALENT: { id: 262624, name: 'Elemental Spirits', icon: 'spell_shaman_feralspirit' },
  EARTHEN_SPIKE_TALENT: { id: 188089, name: 'Earthen Spike', icon: 'ability_earthen_pillar', manaCost: 0.0375 },
  ...
  STATIC_DISCHARGE_TALENT: { id: 342243, name: 'Static Discharge', icon: 'spell_lightning_lightningbolt01', manaCost: 0.0125 },
  AFTERSHOCK_TALENT: { id: 273221, name: 'Aftershock', icon: 'spell_nature_stormreach' },
  ECHOING_SHOCK_TALENT: { id: 320125, name: 'Echoing Shock', icon: 'misc_legionfall_shaman', manaCost: 0.0325 },
  ...
  LIQUID_MAGMA_TOTEM_TALENT: { id: 192222, name: 'Liquid Magma Totem', icon: 'spell_shaman_spewlava', manaCost: 0.035 },
  ...
  ICEFURY_TALENT: { id: 210714, name: 'Icefury', icon: 'spell_frost_iceshard', manaCost: 0.03 },
