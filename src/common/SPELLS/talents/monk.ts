...
const talents: SpellList = {
  ...
  SONG_OF_CHI_JI_TALENT: { id: 198898, name: 'Song of Chi-Ji', icon: 'inv_chaos_orb' },
  ...
  INVOKE_CHI_JI_THE_RED_CRANE_TALENT: { id: 325197, name: 'Invoke Chi-Ji, the Red Crane', icon: 'inv_pet_cranegod', manaCost: 2500 },
