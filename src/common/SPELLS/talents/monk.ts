...
const talents: SpellList = {
	...
	REFRESHING_JADE_WIND_TALENT: { id: 196725, name: "Refreshing Jade Wind", icon: "ability_monk_rushingjadewind", manaCost: 0.035 },
	INVOKE_CHIJI_THE_RED_CRANE_TALENT: { id: 325197, name: "Invoke Chi-Ji, the Red Crane", icon: "inv_pet_cranegod", manaCost: 0.05 },
	...
	DANCE_OF_CHIJI_TALENT: { id: 325201, name: "Dance of Chi-Ji", icon: "ability_monk_cranekick_new" },
	...
	EXPLODING_KEG_TALENT: { id: 325153, name: "Exploding Keg", icon: "archaeology_5_0_emptykegofbrewfatherxinwoyin" },
