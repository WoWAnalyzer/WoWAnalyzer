export default {
  ...
  CLOUDBURST_TOTEM_TALENT: { id: 157153, name: 'Cloudburst Totem', icon: 'ability_shaman_condensationtotem', resourceCost: 860 },
  // Enhancement
  ...
  UNLEASH_LIFE_TALENT: { id: 73685, name: 'Unleash Life', icon: 'spell_shaman_unleashweapon_life', resourceCost: 400 },
  DELUGE_TALENT: { id: 200076, name: 'Deluge', icon: 'ability_shawaterelemental_reform' },
  EARTHGRAB_TOTEM_TALENT: { id: 51485, name: 'Earthgrab Totem', icon: 'spell_nature_stranglevines', resourceCost: 250 },
  ANCESTRAL_VIGOR_TALENT: { id: 207401, name: 'Ancestral Vigor', icon: 'spell_shaman_blessingoftheeternals' },
  EARTHEN_WALL_TOTEM_TALENT: { id: 198838, name: 'Earthen Wall Totem', icon: 'spell_nature_stoneskintotem', resourceCost: 1100 },
  ANCESTRAL_PROTECTION_TOTEM_TALENT: { id: 207399, name: 'Ancestral Protection Totem', icon: 'spell_nature_reincarnation', resourceCost: 1100 },
  ...
  DOWNPOUR_TALENT: { id: 207778, name: 'Downpour', icon: 'ability_mage_waterjet', resourceCost: 1500 },
  HIGH_TIDE_TALENT: { id: 157154, name: 'High Tide', icon: 'spell_shaman_hightide' },
  WELLSPRING_TALENT: { id: 197995, name: 'Wellspring', icon: 'ability_shawaterelemental_split', resourceCost: 2000 },
