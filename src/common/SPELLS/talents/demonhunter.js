export default {
  ...
  RUINOUS_BULWARK_TALENT: { id: 326853, name: 'Last Resort', icon: 'ability_demonhunter_feldevastation' },
  BULK_EXTRACTION_TALENT: { id: 320341, name: 'Last Resort', icon: 'spell_shadow_shadesofdarkness' },
