const talents = {
  ...
  BESTOW_FAITH_TALENT: { id: 223306, name: 'Bestow Faith', icon: 'ability_paladin_blessedmending', manaCost: 600 },
  LIGHTS_HAMMER_TALENT: { id: 114158, name: 'Light\'s Hammer', icon: 'spell_paladin_lightshammer', manaCost: 1800 },
  //25 saved by the light, judgement of light, holy prism
  SAVED_BY_THE_LIGHT: { id: 157047, name: 'Saved by the Light', icon: 'ability_paladin_savedbythelight'},
  HOLY_PRISM_TALENT: { id: 114165, name: 'Holy Prism', icon: 'spell_paladin_holyprism', manaCost: 1300 },
  ...
  //50 Glimmer of Light, Beacon of Faith, Beacon Of Cirtue
