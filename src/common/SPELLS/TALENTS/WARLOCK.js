...
export default {
  ...
  MORTAL_COIL_TALENT: { id: 6789, name: "Mortal Coil", icon: "ability_warlock_mortalcoil" },
  DEMONIC_CIRCLE_TALENT: { id: 268358, name: "Demonic Circle", icon: "spell_shadow_demoniccirclesummon" },
  ...
  DEATHBOLT_TALENT: { id: 264106, name: "Deathbolt", icon: "spell_fire_twilightflamebolt" },
  ...
  HAUNT_TALENT: { id: 48181, name: "Haunt", icon: "ability_warlock_haunt" },
  ...
  DOOM_TALENT: { id: 265412, name: "Doom", icon: "spell_shadow_auraofdarkness" },
  ...
  SHADOWBURN_TALENT: { id: 17877, name: "Shadowburn", icon: "spell_shadow_scourgebuild" },
