...
export default {
  ...
  EARTHGRAB_TOTEM_TALENT: { id: 51485, name: "Earthgrab Totem", icon: "spell_nature_stranglevines", manaCost: 400 },
  SPIRIT_WOLF_TALENT: { id: 260878, name: "Spirit Wolf", icon: "spell_hunter_lonewolf" },
  EARTH_SHIELD_TALENT: { id: 974, name: "Earth Shield", icon: "spell_nature_skinofearth", manaCost: 400 },
  ...
  FORCEFUL_WIND_TALENT: { id: 262647, name: "Forceful Wind", icon: "spell_shaman_unleashweapon_wind" },
  TOTEM_MASTERY_TALENT_ENHANCEMENT: { id: 262395, name: "Totem Mastery", icon: "spell_nature_wrathofair_totem"},
  SEARING_ASSAULT: { id:192087, name: "Searing Assault", icon: "ability_rhyolith_magmaflow_wave"},
  ...
  ELEMENTAL_SPIRIT_TALENT: { id: 262624, name: "Elemental Spirits", icon: "spell_shaman_feralspirit"},
  ...
  ANCESTRAL_PROTECTION_TOTEM_TALENT: { id: 207399, name: "Ancestral Protection Totem", icon: "spell_nature_reincarnation", manaCost: 440 },
  EARTHEN_WALL_TOTEM_TALENT: { id: 198838, name: "Earthen Wall Totem", icon: "spell_nature_stoneskintotem", manaCost: 440 },
  ANCESTRAL_VIGOR_TALENT: { id: 207401, name: "Ancestral Vigor", icon: "spell_shaman_blessingoftheeternals" },
  DOWNPOUR_TALENT: { id: 207778, name: "Downpour", icon: "ability_mage_waterjet", manaCost: 600 },
  CLOUDBURST_TOTEM_TALENT: { id: 157153, name: "Cloudburst Totem", icon: "ability_shaman_condensationtotem", manaCost: 344 },
  WELLSPRING_TALENT: { id: 197995, name: "Wellspring", icon: "ability_shawaterelemental_split", manaCost: 800 },
