export default {
  ...
  WIND_RUSH_TOTEM_TALENT: {
    ...
    description: 'Can be useful on specific encounters to give your entire raid movement speed.',
  },
  // lv45
  LIGHTNING_SURGE_TOTEM_TALENT: {
    ...
    description: 'The default choice in this tier, given that most enemies in raids are immune to roots and hex.',
  },
  EARTHGRAB_TOTEM_TALENT: {
    id: 51485,
    name: 'Earthgrab Totem',
    icon: 'spell_nature_stranglevines',
    description: 'Not recommended for raids, as most enemies will be immune.',
  },
  VOODOO_TOTEM_TALENT: {
    id: 196932,
    name: 'Voodoo Totem',
  ...
  ANCESTRAL_PROTECTION_TOTEM_TALENT: {
    ...
    description: 'Useful on certain fights where you can cheese mechanics with the resurection, or on fights where you need the 10% additional health to survive a mechanic.',
  },
  ...
  ANCESTRAL_VIGOR_TALENT: {
    ...
    description: 'A solid choice. Doesn\'t provide any throughput, but the 10% additional health could end up saving someone.',
  },
  // lv90
  BOTTOMLESS_DEPTHS_TALENT: {
    ...
    description: 'Not recommended. The mana return it provides isn\'t significant enough to pick it.',
  },
  ...
  WELLSPRING_TALENT: {
    ...
    name: 'Wellspring',
    icon: 'ability_shawaterelemental_split',
    description: 'Currently not recommended. Heals too little for too much mana.',
  },
  HIGH_TIDE_TALENT: {
    id: 157154,
    name: 'High Tide',
