...
export default {
  ...
  LIGHTNING_SURGE_TOTEM_TALENT: { id: 192058, name: "Lightning Surge Totem", icon: "spell_nature_brilliance", baseMana: 0.1 },
  EARTHGRAB_TOTEM_TALENT: { id: 51485, name: "Earthgrab Totem", icon: "spell_nature_stranglevines", baseMana: 0.1 },
  VOODOO_TOTEM_TALENT: { id: 196932, name: "Voodoo Totem", icon: "spell_totem_wardofdraining", baseMana: 0.1 },
  ...
  UNLEASH_LIFE_TALENT: { id: 73685, name: "Unleash Life", icon: "spell_shaman_unleashweapon_life", baseMana: 0.05 },
  ...
  ANCESTRAL_PROTECTION_TOTEM_TALENT: { id: 207399, name: "Ancestral Protection Totem", icon: "spell_nature_reincarnation", baseMana: 0.11 },
