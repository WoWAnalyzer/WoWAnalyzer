...
// prettier-ignore
export default [
  change(date(2025, 8, 10), 'Updated <ItemLink id={ITEMS.SAD_SOCKET_ADDING_DEVICE.id} /> to <ItemLink id={ITEMS.TECHNOMANCERS_GIFT.id} /> for Head, Belt, and Bracer socket addition', Ceric),
