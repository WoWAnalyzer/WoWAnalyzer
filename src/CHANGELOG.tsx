...
export default [
  ...
  change(date(2024, 8, 7), 'Prepare for cleanup of Dragonflight items.', Topple),
  ...
  change(date(2024, 8, 1), 'Load routes asynchronously.', Topple),
  ...
  change(date(2024, 7, 25), 'Fix partial support indication on spec list.', Topple),
  ...
  change(date(2024, 7, 15), 'Migrate to pnpm instead of yarn v1.', Topple),
  change(date(2024, 7, 15), 'Replace react-helmet with react-helmet-async.', Topple),
  change(date(2024, 7, 10), 'Improve debugging information for Global Cooldown tracking', emallson),
  change(date(2024, 7, 8), 'Rewrite Premium page in TypeScript.', Topple),
  ...
  change(date(2024, 6, 17), 'Add some TWW patch data.', Topple),
  ...
  change(date(2024, 6, 3), 'Update event meta usage.', Topple),
  ...
  change(date(2024, 5, 22), 'Update k-values for Dragonflight S4.', Topple),
  change(date(2024, 5, 22), 'Update GitHub Actions versions.', Topple),
  change(date(2024, 5, 6), 'Add patch 10.2.7.', Topple),
  change(date(2024, 5, 6), <>Add simple damage mitigated statistic for <ItemLink id={ITEMS.ENDURING_DREADPLATE.id} />.</>, Topple),
  ...
  change(date(2024, 4, 24), 'Bump for season 4 start.', Topple),
  change(date(2024, 4, 22), 'Clean up dead code using knip', Putro),
  change(date(2024, 4, 20), 'Fix friendly/enemy determination', emallson),
  change(date(2024, 4, 17), 'Add 10.2.7 patch.', Topple),
  change(date(2024, 4, 12), 'Fix mana level chart', emallson),
  change(date(2024, 4, 10), 'Update paths used by Sentry.', Topple),
  change(date(2024, 4, 10), 'Update dependencies.', Topple),
  change(date(2024, 4, 9), 'Swap to Vite instead of create-react-app and use the WCL V2 API.', [Topple, emallson]),
  ...
  change(date(2024, 4, 5), 'Fix events tab omitting some events.', Topple),
  change(date(2024, 3, 30), 'Update Nymue spellids and make Channeling normalizer normalize fabricated Prepull events.', Vollmer),
  change(date(2024, 3, 27), 'Rewrite events tab in TypeScript.', Topple),
  change(date(2024, 3, 26), 'Add patch 10.2.6.', Topple),
  change(date(2024, 3, 26), 'Add Dragonflight season 4 M+ dungeons and zone.', Topple),
  change(date(2024, 3, 26), 'Remove support for Shadowlands tier sets.', Topple),
  change(date(2024, 3, 26), 'Add tier set IDs for Dragonflight season 4.', Topple),
  ...
  change(date(2024, 3, 14), 'Fix overflow on cooldown bars while using the phase selector.', Topple),
  change(date(2024, 3, 14), 'Bump opacity on phase selector to 75% from 40%.', Topple),
  change(date(2024, 3, 13), 'Bump opacity on muted text to 75% from 47%.', Topple),
  ...
  change(date(2024, 2, 7), 'Inspect more stack trace lines for external script sources.', Topple),
  change(date(2024, 2, 7), 'Mark 10.2.0 as an old patch.', Topple),
  change(date(2024, 2, 7), 'Fix a crash caused by bad ads.', Topple),
  change(date(2024, 1, 19), 'Fix Dreaming Devotion showing as a cheap enchant.', emallson),
  change(date(2024, 1, 17), 'Simplify raid types and fix M+ S3 icons not showing on fight selection.', Topple),
  change(date(2024, 1, 16), 'Add Ruby Sanctum raid and images for Classic WotLK.', jazminite),
  change(date(2024, 1, 16), 'Add patch 10.2.5.', Topple),
  change(date(2024, 1, 11), <>Add <ItemLink id={ITEMS.POTION_OF_WITHERING_DREAMS_R3.id} /> to healing potion list.</>, Topple),
  change(date(2024, 1, 11), 'Update k-values for 10.2.', Topple),
  change(date(2024, 1, 9), <>Add <ItemLink id={ITEMS.DREAMWALKERS_HEALING_POTION_R3.id} /> to healing potion list.</>, dub),
  change(date(2024, 1, 7), <>Add checklist support for <ItemLink id={ITEMS.FYRALATH.id} />.</>, Topple),
  change(date(2024, 1, 4), <>Add statistics for <ItemLink id={ITEMS.ECHOING_TYRSTONE.id} />.</>, Arbixal),
  change(date(2024, 1, 2), 'Remove Shadowlands food and augment rune support.', Topple),
  change(date(2023, 12, 31), <>Add resource initialization and granularity support for ResourceTracker module.</>, Vollmer),
  change(date(2023, 12, 30), 'Fix errors caused by ESLint update.', Topple),
  change(date(2023, 12, 28), 'Improve internal handling of phases', emallson),
  change(date(2023, 12, 21), <>Mark <ItemLink id={ITEMS.ENCHANT_WEAPON_DREAMING_DEVOTION_R3.id} /> as a max rank enchant.</>, Topple),
  change(date(2023, 12, 20), 'Bring over the ESLint config from the vite migration branch.', Topple),
  change(date(2023, 12, 20), 'Bump i18n dependency version.', Topple),
  change(date(2023, 12, 20), 'Mark 10.1.5 as an old patch.', Topple),
  change(date(2023, 12, 20), 'Bring over a few of the changes from the vite migration branch.', Topple),
  ...
  change(date(2023, 11, 28), 'Bump Node version to 20.x LTS.', Topple),
  change(date(2023, 11, 28), 'Actually populate Sentry releases.', Topple),
  change(date(2023, 11, 28), 'Update Sentry release naming.', Topple),
  ...
  change(date(2023, 11, 19), 'Improve error reporting integration.', Topple),
  change(date(2023, 11, 19), 'Remove warning for 10.2 logs.', Topple),
  change(date(2023, 11, 18), 'Regenerate talents.', Topple),
  ...
  change(date(2023, 11, 15), 'Add backgrounds for Dawn of the Infinites, Everbloom, and Throne of the Tides.', Topple),
  ...
  change(date(2023, 11, 7), 'Add warning for 10.2 logs.', Topple),
  ...
  change(date(2023, 10, 26), 'Add background images for Amirdrassil bosses.', Topple),
  ...
  change(date(2023, 10, 22), 'Disable specs broken by talent regeneration for 10.2.', Topple),
  change(date(2023, 10, 22), 'Regenerate talents for 10.2.', Topple),
  change(date(2023, 10, 22), 'Rename all .js files to .jsx.', Topple),
  change(date(2023, 10, 22), 'Remove articles.', Topple),
  ...
  change(date(2023, 10, 12), 'Simplify checking if a fight is M+.', Topple),
  change(date(2023, 10, 9), 'Add Amirdrassil raid data.', Topple),
  change(date(2023, 10, 9), 'Remove Burning Crusade raid data.', Topple),
  change(date(2023, 10, 9), 'Bump retail version to 10.1.7.', Topple),
  change(date(2023, 10, 9), 'Add T31 set IDs.', Topple),
  change(date(2023, 10, 8), 'Improve spell auto-detection to hopefully include talents.', Topple),
  ...
  change(date(2023, 9, 23), 'Make sure that the Shadowflame Wreathe icon can be displayed.', Topple),
  ...
  change(date(2023, 9, 12), 'Disable M+ logs containing Augmentation Evokers temporarily.', Topple),
  ...
  change(date(2023, 8, 30), 'Update SpellLinks to automatically support talents.', Topple),
  ...
  change(date(2023, 8, 18), 'Update dependencies.', Topple),
  ...
  change(date(2023, 8, 9), 'Fix combatant count in M+.', Topple),
  change(date(2023, 8, 9), 'Disable Augmentation Evoker analysis in M+.', Topple),
  ...
  change(date(2023, 8, 7), 'Remove some deprecated code.', Topple),
  ...
  change(date(2023, 7, 31), <>Add enchantment check for <ItemLink id={ITEMS.SHADOWED_BELT_CLASP_R3.id} />.</>, Topple),
  ...
  change(date(2023, 7, 27), 'Fix i18n in suggestions.', Topple),
  change(date(2023, 7, 25), 'Improve consistency when fetching talents for tables.', Topple),
  change(date(2023, 7, 25), 'Fix crash when using certain i18n functions.', Topple),
  change(date(2023, 7, 23), 'Tooltip on Timeline Improvements', Abelito75),
  change(date(2023, 7, 22), 'Update i18n library version.', [Topple, emallson]),
  ...
  change(date(2023, 7, 17), 'Update spell registration to use `satisfies` keyword', Topple),
  change(date(2023, 7, 17), 'Remove MappedEvent', Tialyss),
  change(date(2023, 7, 17), 'Make patch incompatibility warning more clear.', Topple),
  change(date(2023, 7, 17), 'Add ability to support talents that cost resources per second; regenerate talents.', Topple),
  change(date(2023, 7, 14), 'Updates for Classic Realms', jazminite),
  change(date(2023, 7, 13), 'Mark 10.1.5 as the active patch.', Topple),
  change(date(2023, 7, 10), 'Regenerate talents for 10.1.5.', Topple),
  change(date(2023, 7, 10), 'Update remaining SpellLink usage.', Topple),
  change(date(2023, 7, 9), 'Update SpellLink usage for all classic specs.', Topple),
  change(date(2023, 7, 7), 'Add missing encounters to S2 M+.', Topple),
  change(date(2023, 7, 7), 'Add patch 10.1.5 details.', Topple),
  change(date(2023, 7, 3), 'Fix an issue causing cast efficiency for spells to be artificially inflated', Putro),
  change(date(2023, 6, 30), 'Regenerate talents.', Topple),
  change(date(2023, 6, 28), 'Update retail realms for US, EU, TW, and KR.', Topple),
  change(date(2023, 6, 26), 'Improve ability to have custom ESLint rules.', Topple),
  ...
  change(date(2023, 6, 22), 'Remove ESLint disable from probability module.', Topple),
  ...
  change(date(2023, 6, 17), 'Update core directories to use new spell link format.', Topple),
  change(date(2023, 6, 17), 'Update articles to use new spell link format.', Topple),
  ...
  change(date(2023, 5, 21), 'Refactor raid buff tracking and support tracking Windfury Totem.', Topple),
  change(date(2023, 5, 21), <>Fix <ItemLink id={ITEMS.HISSING_RUNE_R3.id} /> showing as a weak enhancement.</>, Trevor),
  change(date(2023, 5, 21), <>Fix <ItemLink id={ITEMS.LAMBENT_ARMOR_KIT_R3.id} /> showing as a weak enchantment.</>, Topple),
  change(date(2023, 5, 20), <>Add support for <ItemLink id={ITEMS.ENCHANT_WEAPON_SHADOWFLAME_WREATHE_R3.id} />, <ItemLink id={ITEMS.ENCHANT_WEAPON_SPORE_TENDER_R3.id} />, and <ItemLink id={ITEMS.LAMBENT_ARMOR_KIT_R3.id} />.</>, Topple),
  change(date(2023, 5, 17), 'Fix issue with negative Haste values.', emallson),
  change(date(2023, 5, 11), 'Fix multi-rank talent tooltip links.', Topple),
  change(date(2023, 5, 10), 'Add Classic Character Thumbnails to PlayerSelection page.', jazminite),
  change(date(2023, 5, 10), 'Speed up e2e tests.', Topple),
  change(date(2023, 5, 10), 'Fix Echo of Nelthation display.', Topple),
  change(date(2023, 5, 10), 'Add season 2 dungeon backgrounds.', Topple),
  change(date(2023, 5, 10), 'Fix Kazzara displaying as Magmorax.', Topple),
  ...
  change(date(2023, 5, 5), 'Fix Playwright tests.', Topple),
  change(date(2023, 5, 4), 'Add 10.1 patch.', Topple),
  change(date(2023, 5, 2), 'Bumped game version to 10.1', emallson),
  change(date(2023, 4, 24), 'Add ability to filter M+ analysis by dungeon pulls.', Topple),
  ...
  change(date(2023, 4, 20), 'Add M+ season 2 images.', Topple),
  change(date(2023, 4, 19), 'Add Aberrus raid images.', Topple),
  ...
  change(date(2023, 4, 1), 'Remove unnecessary console log.', Topple),
  change(date(2023, 3, 31), 'Refactor SpellLink props to use "spell" instead of "id".', Topple),
  change(date(2023, 3, 31), 'Add Dragonflight season 1 M+ dungeon images.', Topple),
  change(date(2023, 3, 30), 'Add ability to use PTR tooltips based on report zone.', Topple),
  change(date(2023, 3, 29), 'Mark 10.0.5 logs as not current.', Topple),
  change(date(2023, 3, 28), 'Refactor cast breakdown components to make them less noisy.', Topple),
  ...
  change(date(2023, 3, 6), 'Fix combatants not being dispatched to the Redux store.', Topple),
  change(date(2023, 3, 4), 'Add Playwright tests for validating application behavior.', Topple),
  change(date(2023, 3, 3), 'Fix "leech" event throwing errors during development for classic logs.', Topple),
  ...
  change(date(2023, 2, 25), 'Fix spell ID for classic Bloodthirst.', Topple),
  ...
  change(date(2023, 2, 9), <>Add <ItemLink id={ITEMS.POTION_OF_SHOCKING_DISCLOSURE_R3.id} /> to combat potion list.</>, Topple),
  change(date(2023, 2, 6), 'Rewrite test utilities in TypeScript.', Topple),
  ...
  change(date(2023, 1, 26), 'Update performance box rows to use CSS grid instead of flexbox.', Topple),
  change(date(2023, 1, 25), 'Bump retail patch to 10.0.5.', Topple),
  change(date(2023, 1, 24), "Fixed an issue where Guide pages weren't showing by default", Sref),
  change(date(2023, 1, 20), <>Adjust maximum combat potion usages to account for <SpellLink spell={SPELLS.ALACRITOUS_ALCHEMIST_STONE} />.</>, Topple),
  change(date(2023, 1, 18), 'Add missing 3* weapon enhancements.', Topple),
  change(date(2023, 1, 17), 'Add ability to generate PTR talents and add documentation on how to do so.', Topple),
  change(date(2023, 1, 17), 'Add 10.0.5 patch information.', Topple),
  change(date(2023, 1, 16), 'Refactor result page rendering.', Topple),
  change(date(2023, 1, 16), 'Remove remaining references to Shadowlands spells except for foods.', Topple),
  ...
  change(date(2023, 1, 7), 'Update dependencies.', Topple),
  change(date(2023, 1, 7), 'Remove support for Wowdb tooltips.', Topple),
  change(date(2023, 1, 5), 'Make weapon enhancement suggestions more readable.', Topple),
  change(date(2023, 1, 5), 'Fix changelogs showing some contributors as invalid.', Topple),
