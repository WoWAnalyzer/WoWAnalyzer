...
// prettier-ignore
export default [
  change(date(2026, 6, 19), 'Update shared Classic Death Knight EnchantChecker, SPELLS/deathknight data, PlayerInfoEnchants, PlayerInfoGems, and enchantIdMap to support Frost and Unholy.', Darkfrog),
