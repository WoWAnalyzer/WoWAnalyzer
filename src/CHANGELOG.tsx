...
// prettier-ignore
export default [
  change(date(2020, 12, 22), <> Add support for <ItemLink id={ITEMS.DARKMOON_DECK_VORACITY.id} /> and correct downtime issues in fights where you had <SpellLink id={SPELLS.POWER_INFUSION.id} />.</>, Putro),
