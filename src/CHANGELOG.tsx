...
import { Abelito75, AdamKelly, Adoraci, Amani, Barter, ChagriAli, ChristopherKiss, Dambroda, emallson, Guyius, Haelrail, HolySchmidt, Jafowler, jos3p, joshinator, Juko8, Keraldi, Khazak, Kruzershtern, Mae, Moonrabbit, niseko, Putro, Sharrq, Ssabbar, Zeboot, Zerotorescue, Scotsoo } from 'CONTRIBUTORS';
...
// prettier-ignore
export default [
  change(date(2020, 12, 28), <>Fixed issue with overview when no weapon equipped.</>, Scotsoo),
