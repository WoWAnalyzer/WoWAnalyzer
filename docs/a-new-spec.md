...
* A **dynamic cooldown** may require a custom function to define the potential cast efficiency. Examples:
    * [METAMORPHOSIS_HAVOC](../src/Parser/DemonHunter/Havoc/Modules/Abilities.js) - artifact relic trait reduces cooldown
    ...
    * [HEALING_STREAM_TOTEM_CAST](../src/Parser/Shaman/Restoration/Modules/Abilities.js) - other spell interactions with tier bonus reduces cooldown
