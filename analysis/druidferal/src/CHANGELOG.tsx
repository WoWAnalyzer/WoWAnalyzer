...
export default [
  change(date(2021, 6, 26), <>Fixed a bug where <SpellLink id={SPELLS.ADAPTIVE_SWARM.id}/> stats would only appear if player is specced for <SpellLink id={SPELLS.LUNAR_INSPIRATION_TALENT.id}/>.</>, Sref),
