...
export default [
  change(date(2022, 4, 15), <>Changed the <SpellLink id={SPELLS.COORDINATED_OFFENSIVE.id} /> module to track if combatant is fixating spirits to benefit from it.</>, nullDozzer),
