...
export default [
  change(date(2021, 12, 12), <> Updated the APL Checker to also enforce recommend early refreshes of <SpellLink id={SPELLS.STEADY_FOCUS_TALENT.id} /> if your last cast was <SpellLink id={SPELLS.STEADY_SHOT}/>. </> , Putro),
