...
export default [
  ...
  change(date(2022, 2, 18), <>Added stat boxes for upcoming tier set bonuses - <SpellLink id={SPELLS.RESTO_DRUID_TIER_28_2P_SET_BONUS.id} /> and <SpellLink id={SPELLS.RESTO_DRUID_TIER_29_4P_SET_BONUS.id} /></>, Sref),
