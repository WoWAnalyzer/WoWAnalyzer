...
import { mergeTimePeriods, OpenTimePeriod } from 'parser/core/timePeriods';
  ...
  subStatistic() {
    ...
    if (this.hasDTL) {
      subBars.push({
        ...
        uptimes: mergeTimePeriods(this.dtlUptimes, {start: this.owner.fight.start_time, end: this.owner.currentTimestamp}),
        color: DTL_COLOR,
      });
    }
    ...
    return uptimeBarSubStatistic(
      this.owner.fight,
      {
        ...
        uptimes: mergeTimePeriods(this.lifebloomUptimes, {start: this.owner.fight.start_time, end: this.owner.currentTimestamp}),
        color: LB_COLOR,
      },
      subBars,
