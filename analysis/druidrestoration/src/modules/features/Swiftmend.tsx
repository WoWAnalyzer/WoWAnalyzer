...
import SoulOfTheForest from '../talents/SoulOfTheForest';
...
class Swiftmend extends Analyzer {
  ...
  hotTracker!: HotTrackerRestoDruid;
  combatants!: Combatants;
  soulOfTheForest!: SoulOfTheForest; // TODO find a way to do Guide without depending on this
        ...
        {this.hasSotf && (
          <>
            <p>
              ...
              should always use your proc before casting Convoke to avoid overwriting or consuming
              on a bad target. Never let a proc expire.
            </p>
            <p>
              <strong>Soul of the Forest usage</strong>
              <small>
                {' '}
                - Green is a Wild Growth use, Yellow is a Rejuvenation or Regrowth use, and Red is
                an expired or overwritten proc. Mouseover for more details.
              </small>
              {this.soulOfTheForest.guideTimeline}
            </p>
          </>
        )}
      </SubSection>
