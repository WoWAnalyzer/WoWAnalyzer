...
export default class WordOfGlory extends Analyzer {
  ...
  suggestions(when: When) {
    ...
    when(this.sotrSuggestion).addSuggestion((suggest, actual, recommended) =>
      suggest(
        <>
          Avoid letting your <SpellLink id={SPELLS.SHINING_LIGHT.id} /> buffs last too long. This
          wastes stacks that would be generated by{' '}
          <SpellLink id={SPELLS.SHIELD_OF_THE_RIGHTEOUS.id} />.
        </>,
      )
        .icon(SPELLS.SHINING_LIGHT.icon)
