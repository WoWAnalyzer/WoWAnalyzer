...
export const DEADLY_TANDEM_CA_DURATION_INCREASE = [
  0, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000,
];
/** Flame Infusion */
...
export const FLAME_INFUSION_WFB_DAMAGE_INCREASE = [
  0, 0.1, 0.11, 0.12, 0.13, 0.14, 0.15, 0.16, 0.17, 0.18, 0.19, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25,
];
...
export const STINGING_STRIKE_RS_MB_DMG_INCREASE = [
  0, 0.14, 0.16, 0.17, 0.19, 0.2, 0.22, 0.23, 0.25, 0.26, 0.28, 0.29, 0.31, 0.32, 0.34, 0.35,
];
...
export const STRENGTH_OF_THE_PACK_DAMAGE_MODIFIER = [
  0, 0.03, 0.04, 0.04, 0.05, 0.05, 0.06, 0.06, 0.07, 0.07, 0.08, 0.08, 0.09, 0.09, 0.1, 0.1,
];
//endregion
