...
class StormstoutsLastKeg extends Analyzer {
  ...
  trackExtraCD(_event: CastEvent) {
    const expectedDuration = this.spellUsable.fullCooldownDuration(SPELLS.KEG_SMASH.id);
    const chargesOnCooldown = this.spellUsable.chargesOnCooldown(SPELLS.KEG_SMASH.id);
