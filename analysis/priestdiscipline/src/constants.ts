...
export const SHINING_RADIANCE_INCREASE = [
  0, 0.4, 0.44, 0.48, 0.52, 0.56, 0.6, 0.64, 0.68, 0.72, 0.76, 0.8, 0.84, 0.88, 0.92, 0.96,
];

export const EXALTATION_SPIRIT_SHELL_INCREASE = [
  0.05, 0.055, 0.06, 0.065, 0.07, 0.075, 0.08, 0.085, 0.09, 0.095, 0.1, 0.105, 0.11, 0.115, 0.12,
];

export const SHATTERED_PERCEPTIONS_INCREASE = [
  0.13, 0.143, 0.156, 0.169, 0.182, 0.195, 0.208, 0.221, 0.234, 0.247, 0.26, 0.273, 0.286, 0.299,
  0.312,
];
